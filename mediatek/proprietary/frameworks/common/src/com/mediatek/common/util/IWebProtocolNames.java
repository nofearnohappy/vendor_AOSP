...
public interface IWebProtocolNames {
    ...
    /**
     * Return extended valid web protocal string like "HTTP|HTTp|ftp|".
     * For none case sensitive, wrap the pattern with (?i)/(?-i). Ex: "(?i)http|ftp|(?-i)".
     * The string must ends with a "|".
     * @return the marged protocal name by regular expression
     */
