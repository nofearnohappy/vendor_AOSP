...
public interface IOnlyOwnerSimSupport {
    ...
    /**
       * Check feature (ro.mtk_owner_sim_support)  is 1  or 0.
       *
       * @return Returns true if ro.mtk_owner_sim_support is 1.
       */
    ...
    /**
       ...
       * In this method ,we will firstly call isOnlyOwnerSimSupportOn() to ensure feature (ro.mtk_owner_sim_support) is 1.
       *
       * @return Returns true if ro.mtk_owner_sim_support is 0, or CurrentUser is  Owner and ro.mtk_owner_sim_support is 1 .
       */
