...
interface DmAgent {
     ...
     * @internal
     */
    boolean writeIccID1(in byte[] iccID, in int size);
     ...
     * @internal
     */
    boolean writeIccID2(in byte[] iccID, in int size);
     ...
     * @internal
     */
    boolean setSelfRegisterFlag(in byte[] flag, in int size);
