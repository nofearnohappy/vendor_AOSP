...
interface IAudioProfileService {
    ...
    boolean isVibrationEnabled(String profileKey);
    boolean isDtmfToneEnabled(String profileKey);
    boolean isSoundEffectEnabled(String profileKey);
    boolean isLockScreenEnabled(String profileKey);
    boolean isVibrateOnTouchEnabled(String profileKey);
    ...
    void setVibrateOnTouchEnabled(String profileKey, boolean enabled);
    void setProfileName(String profileKey, String newName);
    void setUserId (int userId);
    
    boolean isActiveProfile(String profileKey);
