...
public class AudioProfileListener {
     ...
     * @hide
     */
    public static final int STOP_LISTEN = 0;

    /**
     * Listen for changes to the audioprofile .
     *
     * @see #onProfileChanged
     * @hide
     */
    public static final int LISTEN_PROFILE_CHANGE = 0x00000001;
    ...
    IAudioProfileListener callback = new IAudioProfileListener.Stub() {
        public void onProfileChanged(String profileKey) {
            Message.obtain(mHandler, LISTEN_PROFILE_CHANGE, 0, 0, profileKey).sendToTarget();
        }
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case LISTEN_PROFILE_CHANGE:
                    AudioProfileListener.this.onProfileChanged((String) msg.obj);
                    break;
