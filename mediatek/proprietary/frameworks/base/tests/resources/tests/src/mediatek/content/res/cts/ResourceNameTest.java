...
public class ResourceNameTest extends AndroidTestCase {
    ...
    public void testGetResourceName() {
        ...
        assertEquals("com.mediatek.cts.resource.stub:configVarying/simple", fullName);

        final String packageName = res.getResourcePackageName(R.configVarying.simple);
        assertEquals("com.mediatek.cts.resource.stub", packageName);
