...
public class AccountViewAdapter extends BaseAdapter {
     ...
     * @param data A list with AccountElements data type. The list contains the data of each account and
     *        the each member of AccountElements will correspond to one item view.
     */
    ...
    * @param data The List of accountElements
    * @internal
    */
