 ...
 */
public class TedongleStateListener {
     ...
     */
    ITedongleStateListener callback = new ITedongleStateListener.Stub() {
        public void onServiceStateChanged(ServiceState serviceState) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case LISTEN_SERVICE_STATE:
                    TedongleStateListener.this.onServiceStateChanged((ServiceState)msg.obj);
                    break;
                case LISTEN_SIGNAL_STRENGTH:
                    TedongleStateListener.this.onSignalStrengthChanged(msg.arg1);
                    break;
                case LISTEN_MESSAGE_WAITING_INDICATOR:
                    TedongleStateListener.this.onMessageWaitingIndicatorChanged(msg.arg1 != 0);
                    break;
                case LISTEN_CALL_FORWARDING_INDICATOR:
                    TedongleStateListener.this.onCallForwardingIndicatorChanged(msg.arg1 != 0);
                    break;
                case LISTEN_CELL_LOCATION:
                    TedongleStateListener.this.onCellLocationChanged((CellLocation)msg.obj);
                    break;
                case LISTEN_CALL_STATE:
                    TedongleStateListener.this.onCallStateChanged(msg.arg1, (String)msg.obj);
                    break;
                case LISTEN_DATA_CONNECTION_STATE:
                    TedongleStateListener.this.onDataConnectionStateChanged(msg.arg1, msg.arg2);
                    TedongleStateListener.this.onDataConnectionStateChanged(msg.arg1);
                    break;
                case LISTEN_DATA_ACTIVITY:
                    TedongleStateListener.this.onDataActivity(msg.arg1);
                    break;
                case LISTEN_SIGNAL_STRENGTHS:
                    TedongleStateListener.this.onSignalStrengthsChanged((SignalStrength)msg.obj);
                    break;
                case LISTEN_OTASP_CHANGED:
                    TedongleStateListener.this.onOtaspChanged(msg.arg1);
                    break;
                case LISTEN_CELL_INFO:
                    TedongleStateListener.this.onCellInfoChanged((List<CellInfo>)msg.obj);
            }
        }
    };
}
