...
import com.android.internal.tedongle.ICarrierConfigLoader;
...
public class CdmaServiceStateTracker extends ServiceStateTracker {
    ...
    */
    ...
    protected String getHomeOperatorNumeric() {
        String numeric = TelephonyManager.getDefault().
    ...
    protected void updateRoamingState() {
        ICarrierConfigLoader configLoader = null;
    ...
    boolean isRoamingBetweenOperators(boolean cdmaRoaming, ServiceState s) {
        String spn = TelephonyManager.getDefault().
    ...
    void setTimeFromNITZString (String nitz, long nitzReceiveTime)
    {
        ...
        try {
            ...
            String iso = TelephonyManager.getDefault().
    ...
    String getImsi() {
        ...
        String operatorNumeric = TelephonyManager.getDefault().
                getSimOperatorNumericForPhone(mPhoneBase.getPhoneId());
