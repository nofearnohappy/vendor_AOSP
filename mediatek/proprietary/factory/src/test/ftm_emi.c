...
*/
    ...
    emi->stress_result=false;
    ptr += sprintf(ptr, "-->%s,\nNeed to Disable TEE Feature. \n", emi->stress_result ? uistr_pass : uistr_fail);
    printf("Need to disable TEE Feature\n");
    goto entry_exit;
#endif
