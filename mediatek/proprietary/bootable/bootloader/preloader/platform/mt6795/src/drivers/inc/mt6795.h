...
#define SSUSB_SIFSLV_SPLLC_BASE             (USB_SIF_BASE + 0x000)
#define SSUSB_SIFSLV_IPPC_BASE			    (USB_SIF_BASE + 0x700)
#define SSUSB_SIFSLV_U2PHY_COM_BASE		    (USB_SIF_BASE + 0x800)
#define SSUSB_SIFSLV_U3PHYD_BASE            (USB_SIF_BASE + 0x900)
