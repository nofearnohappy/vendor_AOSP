...
#define FREQREG_SIZE 19
#else	
#define FREQREG_SIZE 13
#endif	
...
typedef struct _PLL_SETTING_T
{
    U16 frequency;
    // MPLL frequency-dependent parameters
    U32 MPLL_POSDIV_2_0;
    U32 MPLL_SDM_PCW_20_0;
    
    // MEMPLL frequency-dependent parameters
    U32 MEMPLL_FBDIV_6_0;
    U32 MEMPLL_FBDIV2_6_0;
    U32 MEMPLL_M4PDIV_1_0;
    U32 MEMPLL_BR_1_0;
    U32 MEMPLL_BC_1_0;
    U32 MEMPLL_IR_3_0;
    U32 MEMPLL_IC_3_0;
...
#endif
DRAM_STATUS_T DramcInitDefault(DRAMC_CTX_T *p);
...
void DramcDual_MR2(DRAMC_CTX_T *p);
...
extern U32 DUAL_FREQ_LOW, DUAL_FREQ_HIGH;
#if defined(DFS_HOPPING_MAX) || defined(DFS_HOPPING_FINETUNE_MIN)
extern U32 DFS_Hopping_Disable;
#endif
// API prototypes.
