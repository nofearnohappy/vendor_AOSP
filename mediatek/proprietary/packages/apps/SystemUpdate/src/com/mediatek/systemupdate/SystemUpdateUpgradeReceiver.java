...
public class SystemUpdateUpgradeReceiver extends BroadcastReceiver {
    ...
    private static final String GOOGLE_OTA_PRE_FILE_PATH =
            "/data/data/com.mediatek.systemupdate/shared_prefs/googleota.xml";
    private static final String SYSTEM_UPDATE_PRE_FILE_PATH =
            "/data/data/com.mediatek.systemupdate/shared_prefs/system_update.xml";
