...
public class FdPresenterImpl implements IFdPresenterListener, IDetectionPresenter {
    ...
    private static final String TAG = FdPresenterImpl.class.getSimpleName();
    ...
    public void startDetection() {
        if (mIsFdStarted) {
            Log.i(TAG, "face detection has been stared so return");
            return;
        }
    ...
    public void stopDetection() {
        if (!mIsFdStarted) {
            Log.i(TAG, "face detection has been stopped or not open so return");
            return;
        }
