...
public class DatabaseManager {
    ...
    private static void updateDataBase(Context context) {
        ...
        Log.e("@M_" + TAG, "removedPkgList = " + removedPkgList + " check whether it installed under sdcard");
    ...
    private static List<String> getRemovePkg(
        ...
        if (currentDB == null) {
            Log.d("@M_" + TAG, "First time boot up or database no data stored in");
            return null;
        }
    ...
    private static HashMap<String, List<PermissionRecord>>
        ...
        if (currentInstall == null) {
            Log.d("@M_" + TAG, "No app installed in phone");
            return null;
        }
    ...
    private static List<PermissionRecord> getPermRecordListForNewPkg(String pkgName, List<Permission> permList) {
        ...
        if (permRecordList == null) {
            Log.e("@M_" + TAG, "permRecordList = null");
            return null;
        }
        if (sPkgKeyCache.containsKey(pkgName)) {
    ...
    private static void modifyCache(PermissionRecord permRecord) {
        ...
        if (permRecordList != null) {
            ...
            Log.e("@M_" + TAG, "Something not right need to check mPackageName = " + permRecord.mPackageName);
        }
        ...
        if (permRecordList != null) {
            ...
            Log.e("@M_" + TAG, "Something not right need to check mPermissionName = " + permRecord.mPermissionName);
        }
    }
    enum KEY_TYPE {
        Pkg_Key,
