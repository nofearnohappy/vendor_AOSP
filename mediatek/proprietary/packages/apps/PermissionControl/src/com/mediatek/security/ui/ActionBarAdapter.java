...
public class ActionBarAdapter {
    ...
    private class MyTabListener implements ActionBar.TabListener {
        ...
        public void onTabSelected(Tab tab, FragmentTransaction ft) {
            Log.d("@M_" + TAG, "onTabSelected() " + " ignore ? " + mIgnoreTabSelected);
            if (!mIgnoreTabSelected) {
                Log.d("@M_" + TAG, "setCurrentTab()");
    ...
    public void setCurrentTab(TabState tab, boolean notifyListener) {
        ...
        if (tab == mCurrentTab) {
            Log.d("@M_" + TAG, "tab == mCurrentTab ,directly return " + tab);
            return;
        }
        mCurrentTab = tab;
        Log.d("@M_" + TAG, "mCurrentTab = " + mCurrentTab + " notifyListner "
                + notifyListener);
    ...
    private void update() {
        if (mActionBar.getNavigationMode() != ActionBar.NAVIGATION_MODE_TABS) {
            Log.d("@M_" + TAG, "update() " + mCurrentTab.ordinal() + mCurrentTab);
    ...
    public void onSaveInstanceState(Bundle outState) {
        Log.d("@M_" + TAG, "onSaveInstanceState() " + mCurrentTab.ordinal());
