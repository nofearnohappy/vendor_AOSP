...
public class SPAddLockSetting extends SimLockBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEtMccMnc = (EditText) findViewById(R.id.idspaddlockEditInputMCCMNC);
        mEtGid1 = (EditText) findViewById(R.id.idspaddlockEditInputGID1);

        // Let the user to choose "put in" for just read MCCMNC from the SIM
        // card
        mSpinner1 = (Spinner) findViewById(R.id.spinnersp1);
        ...
        mSpinner2 = (Spinner) findViewById(R.id.spinnersp2);
        ...
        mEtPwd = (EditText) findViewById(R.id.idspaddlockInputEditPassword);
        mEtPwdConfirm = (EditText) findViewById(R.id.idspaddlockEditInputPasswordAgain);
        ...
        btnConfirm.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View view) {
                ...
                if ((!mMccMncReadSim)
                    ...
                    setIccNetworkLockEnabled(2, 2, mEtPwd.getText().toString(),
                            mMccMncReadSim ? mSimMccMnc : mEtMccMnc.getText().toString(),
                            mGid1ReadSim ? mSimGid1 : mEtGid1.getText().toString(), null, callback);
                }
            }
        });
