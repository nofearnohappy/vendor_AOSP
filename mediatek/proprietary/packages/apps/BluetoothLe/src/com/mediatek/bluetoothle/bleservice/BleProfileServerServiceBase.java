...
/**
 * Base class for each Ble Profile Server Service
 */
public abstract class BleProfileServerServiceBase extends BleProfileServiceBase {

    /**
     * Get all the current supported profile ids
     *
     * @return an array of supported profile id
     */
    public abstract int[] getProfileIds();
    /**
     * Get current supported IBleProfileServer objects
     *
     * @return an array of supported IBleProfileServer objects
     */
