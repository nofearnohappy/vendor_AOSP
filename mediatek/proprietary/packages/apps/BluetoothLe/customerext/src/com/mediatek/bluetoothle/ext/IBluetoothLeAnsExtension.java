...
public interface IBluetoothLeAnsExtension {
    /**
     * get user-defined detector array list
     * 
     * @param context
     * @return A arrayList with content type is BluetoothAnsDetector
     */
    ArrayList<BluetoothAnsDetector> getDetectorArray(Context context);

    /**
     * get a set with category IDs that user-defined detector used
     * 
     * @return
     */
