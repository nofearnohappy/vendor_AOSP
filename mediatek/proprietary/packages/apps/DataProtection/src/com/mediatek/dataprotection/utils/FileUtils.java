...
public final class FileUtils {
    ...
    public static String getFileMimeType(FileInfo fileInfo) {
        String mimeType = null;

        if (fileInfo != null) {
            // String extension =
            // getFileExtension(fileInfo.getFileAbsolutePath());
            mimeType = MediaFile.getMimeTypeForFile(fileInfo
                    .getFileAbsolutePath());
        }
        return mimeType;
