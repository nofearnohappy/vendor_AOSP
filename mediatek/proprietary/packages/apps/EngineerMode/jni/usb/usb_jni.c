...
JNIEXPORT jboolean JNICALL Java_com_mediatek_engineermode_usb_UsbDriver_nativeInit(JNIEnv * env,
        jobject obj) {
...
JNIEXPORT jboolean JNICALL Java_com_mediatek_engineermode_usb_UsbDriver_nativeStopTest(JNIEnv * env,
        jobject obj, jint test_nr) {
    if (fd == -1) {
        OTG_LOG("FD == -1\n");
        return JNI_FALSE;
    }
...
JNIEXPORT jint JNICALL Java_com_mediatek_engineermode_usb_UsbDriver_nativeGetMsg(JNIEnv * env,
        jobject obj) {
    if (fd == -1) {
        OTG_LOG("FD == -1\n");
        return 0;
...
JNIEXPORT jboolean JNICALL Java_com_mediatek_engineermode_usb_UsbDriver_nativeCleanMsg(JNIEnv * env,
        jobject obj) {
    int ret;
