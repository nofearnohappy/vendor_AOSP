...
#define CORE_NUMBER_MAX CORE_NUMBER_8
...
#define INDEX_TEST_IDLE2MAX 11
#define INDEX_TEST_MAX INDEX_TEST_IDLE2MAX
...
#define INDEX_FORCE_CORE_ENABLE_TEST_MODE 1
#define INDEX_FORCE_CORE_DISABLE_TEST_MODE 2
#define INDEX_FORCE_CORE_CUSTOM 3
...
#define FILE_CA15_4 "/sys/bus/platform/drivers/slt_cpu4_ca15l_maxpower/slt_cpu4_ca15l_maxpower"
#define FILE_CA15_5 "/sys/bus/platform/drivers/slt_cpu5_ca15l_maxpower/slt_cpu5_ca15l_maxpower"
#define FILE_CA15_6 "/sys/bus/platform/drivers/slt_cpu6_ca15l_maxpower/slt_cpu6_ca15l_maxpower"
#define FILE_CA15_7 "/sys/bus/platform/drivers/slt_cpu7_ca15l_maxpower/slt_cpu7_ca15l_maxpower"
...
#define FILE_CPU_IDLE "/proc/cpu_idle/cpu_idle"

#define FILE_HOTPLUG "/proc/mtk_hotplug/enable"
#define FILE_HOTPLUG_VER2 "/proc/hps/enabled"

#define FILE_MAX_POWER64_0 "TO_DO_CPU0_MAX_POWER64"
#define FILE_MAX_POWER64_1 "TO_DO_CPU1_MAX_POWER64"
#define FILE_MAX_POWER64_2 "TO_DO_CPU2_MAX_POWER64"
#define FILE_MAX_POWER64_3 "TO_DO_CPU3_MAX_POWER64"
#define FILE_MAX_POWER64_4 "TO_DO_CPU4_MAX_POWER64"
#define FILE_MAX_POWER64_5 "TO_DO_CPU5_MAX_POWER64"
#define FILE_MAX_POWER64_6 "TO_DO_CPU6_MAX_POWER64"
#define FILE_MAX_POWER64_7 "TO_DO_CPU7_MAX_POWER64"

#define FILE_DHRYSTONE64_0 "TO_DO_CPU0_DHRYSTONE_64"
#define FILE_DHRYSTONE64_1 "TO_DO_CPU1_DHRYSTONE_64"
#define FILE_DHRYSTONE64_2 "TO_DO_CPU2_DHRYSTONE_64"
#define FILE_DHRYSTONE64_3 "TO_DO_CPU3_DHRYSTONE_64"
#define FILE_DHRYSTONE64_4 "TO_DO_CPU4_DHRYSTONE_64"
#define FILE_DHRYSTONE64_5 "TO_DO_CPU5_DHRYSTONE_64"
#define FILE_DHRYSTONE64_6 "TO_DO_CPU6_DHRYSTONE_64"
#define FILE_DHRYSTONE64_7 "TO_DO_CPU7_DHRYSTONE_64"

#define FILE_SAXPY_0 "/sys/bus/platform/drivers/slt_cpu0_saxpy/slt_cpu0_saxpy"
#define FILE_SAXPY_1 "/sys/bus/platform/drivers/slt_cpu1_saxpy/slt_cpu1_saxpy"
#define FILE_SAXPY_2 "/sys/bus/platform/drivers/slt_cpu2_saxpy/slt_cpu2_saxpy"
#define FILE_SAXPY_3 "/sys/bus/platform/drivers/slt_cpu3_saxpy/slt_cpu3_saxpy"
#define FILE_SAXPY_4 "/sys/bus/platform/drivers/slt_cpu4_saxpy/slt_cpu4_saxpy"
#define FILE_SAXPY_5 "/sys/bus/platform/drivers/slt_cpu5_saxpy/slt_cpu5_saxpy"
#define FILE_SAXPY_6 "/sys/bus/platform/drivers/slt_cpu6_saxpy/slt_cpu6_saxpy"
#define FILE_SAXPY_7 "/sys/bus/platform/drivers/slt_cpu7_saxpy/slt_cpu7_saxpy"

#define FILE_SAXPY64_0 "TO_DO_CPU0_SAXPY_64"
#define FILE_SAXPY64_1 "TO_DO_CPU1_SAXPY_64"
#define FILE_SAXPY64_2 "TO_DO_CPU2_SAXPY_64"
#define FILE_SAXPY64_3 "TO_DO_CPU3_SAXPY_64"
#define FILE_SAXPY64_4 "TO_DO_CPU4_SAXPY_64"
#define FILE_SAXPY64_5 "TO_DO_CPU5_SAXPY_64"
#define FILE_SAXPY64_6 "TO_DO_CPU6_SAXPY_64"
#define FILE_SAXPY64_7 "TO_DO_CPU7_SAXPY_64"

#define FILE_ADV_SIM_0 "/sys/bus/platform/drivers/slt_cpu0_simd/slt_cpu0_simd"
#define FILE_ADV_SIM_1 "/sys/bus/platform/drivers/slt_cpu1_simd/slt_cpu1_simd"
#define FILE_ADV_SIM_2 "/sys/bus/platform/drivers/slt_cpu2_simd/slt_cpu2_simd"
#define FILE_ADV_SIM_3 "/sys/bus/platform/drivers/slt_cpu3_simd/slt_cpu3_simd"
#define FILE_ADV_SIM_4 "/sys/bus/platform/drivers/slt_cpu4_simd/slt_cpu4_simd"
#define FILE_ADV_SIM_5 "/sys/bus/platform/drivers/slt_cpu5_simd/slt_cpu5_simd"
#define FILE_ADV_SIM_6 "/sys/bus/platform/drivers/slt_cpu6_simd/slt_cpu6_simd"
#define FILE_ADV_SIM_7 "/sys/bus/platform/drivers/slt_cpu7_simd/slt_cpu7_simd"

#define FILE_IDLE2MAX_0 "/sys/bus/platform/drivers/slt_cpu0_maxtrans/slt_cpu0_maxtrans"
#define FILE_IDLE2MAX_1 "/sys/bus/platform/drivers/slt_cpu1_maxtrans/slt_cpu1_maxtrans"
#define FILE_IDLE2MAX_2 "/sys/bus/platform/drivers/slt_cpu2_maxtrans/slt_cpu2_maxtrans"
#define FILE_IDLE2MAX_3 "/sys/bus/platform/drivers/slt_cpu3_maxtrans/slt_cpu3_maxtrans"
#define FILE_IDLE2MAX_4 "/sys/bus/platform/drivers/slt_cpu4_maxtrans/slt_cpu4_maxtrans"
#define FILE_IDLE2MAX_5 "/sys/bus/platform/drivers/slt_cpu5_maxtrans/slt_cpu5_maxtrans"
#define FILE_IDLE2MAX_6 "/sys/bus/platform/drivers/slt_cpu6_maxtrans/slt_cpu6_maxtrans"
#define FILE_IDLE2MAX_7 "/sys/bus/platform/drivers/slt_cpu7_maxtrans/slt_cpu7_maxtrans"
...
#define MODE_RADIO_BACKUP_RESTORE 1
#define MODE_CHECK_CUSTOM 2
#define MODE_CUSTOM_V2 3
#define FORCE_CORE_OFF 0
#define FORCE_CORE_RUN 1
#define FORCE_CORE_IDLE 2
#define FORCE_CORE_DO_NOTHING 0
#define FORCE_CORE_ENABLE 1
#define FORCE_CORE_DISABLE 7
#define CPU_ARCH_BIG_LITTLE 3
...
#define COMMAND_SWCODEC_TEST_CORE_0 "/system/bin/mp4dec_ut_stress /data/352x288_30_512.cmp 1 0"
#define COMMAND_SWCODEC_TEST_CORE_1 "/system/bin/mp4dec_ut_stress /data/352x288_30_512.cmp 1 1"
#define COMMAND_SWCODEC_TEST_CORE_2 "/system/bin/mp4dec_ut_stress /data/352x288_30_512.cmp 1 2"
#define COMMAND_SWCODEC_TEST_CORE_3 "/system/bin/mp4dec_ut_stress /data/352x288_30_512.cmp 1 3"

#define COMMAND_SWCODEC_TEST_CORE_4 "/system/bin/mp4dec_ut_stress /data/352x288_30_512.cmp 1 4"
#define COMMAND_SWCODEC_TEST_CORE_5 "/system/bin/mp4dec_ut_stress /data/352x288_30_512.cmp 1 5"
#define COMMAND_SWCODEC_TEST_CORE_6 "/system/bin/mp4dec_ut_stress /data/352x288_30_512.cmp 1 6"
#define COMMAND_SWCODEC_TEST_CORE_7 "/system/bin/mp4dec_ut_stress /data/352x288_30_512.cmp 1 7"
...
#define COMMAND_DISABLE_PVLK_ALARM "echo 0 > /proc/mtprof/pvlk"
...
struct force_core_test_files_t {
