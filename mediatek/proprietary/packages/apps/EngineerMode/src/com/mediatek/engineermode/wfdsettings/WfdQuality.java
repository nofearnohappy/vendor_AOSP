...
public class WfdQuality extends Activity implements OnClickListener {
    ...
    private boolean onClickBtnDone() {
        ...
        Log.v("@M_" + TAG, "Display toast time : " + mToastTime);
        Log.v("@M_" + TAG, "Display notification time : " + mNotifTime);
        Log.v("@M_" + TAG, "Sqc info : " + mCbSqcInfo.isChecked());
        Log.v("@M_" + TAG, "Quality enhancement : " + mCbQeInfo.isChecked());
        Log.v("@M_" + TAG, "Auto channel selection : " + mCbAcsInfo.isChecked());
        return true;
    }
