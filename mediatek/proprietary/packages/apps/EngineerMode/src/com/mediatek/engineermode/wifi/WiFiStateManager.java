        ...
        if (mWifiManager != null) {
            ...
            if (EMWifi.sIsInitialed) {
                ...
                if (mChipID == CHIP_ID_6620 || mChipID == CHIP_ID_5921) {
                    Log.d("@M_" + TAG, "Initialize succeed");
                    long result = -1;
                    ...
                    if (result == 0) {
                        ...
                        Log.i("@M_" + TAG, "setTestMode succeed");
                    } else {
                        Log.w("@M_" + TAG, "setTestMode failed, ERROR_CODE = "
                                + result);
    ...
    public void disableWiFi() {
        if (mWifiManager != null) {
            if (mWifiManager.setWifiEnabled(false)) {
                Log.d("@M_" + TAG, "disable wifi power succeed");
            } else {
                Log.w("@M_" + TAG, "disable wifi power failed");
            }
        }
    }
}
