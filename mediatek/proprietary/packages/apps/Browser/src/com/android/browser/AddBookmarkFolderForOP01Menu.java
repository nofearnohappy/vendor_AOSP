...
public class AddBookmarkFolderForOP01Menu extends Activity implements View.OnClickListener,
    ...
    private void switchToDefaultView(boolean changedFolder) {
        ...
        if (changedFolder) {
            ...
            // selection.
            Log.e("@M_" + XLOGTAG, "mCurrentFolder:" + mCurrentFolder);
...
*/
    ...
    public void onSetSelection(long id) {
        Log.e("@M_" + XLOGTAG, "onSetSelection id :" + id);
        int intId = (int) id;
    ...
    private long addFolderToCurrent(String name) {
        ...
        if (mIsRecentFolder) {
            ...
            Log.d("@M_" + XLOGTAG, "not changed");
            values.put(BrowserContract.Bookmarks.PARENT, mOriginalFolder);
        } else {
            Log.d("@M_" + XLOGTAG, "defaultFolder");
            values.put(BrowserContract.Bookmarks.PARENT, currentFolder);
        }
        Log.e("@M_" + XLOGTAG, "values:" + values.get(BrowserContract.Bookmarks.PARENT));
    ...
    protected void onCreate(Bundle icicle) {
        ...
        Log.d("@M_" + XLOGTAG, "mCurrentFolder:" + mCurrentFolder + " mRootFolder:" + mRootFolder);
