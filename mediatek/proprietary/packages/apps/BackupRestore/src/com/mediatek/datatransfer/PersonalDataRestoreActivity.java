...
public class PersonalDataRestoreActivity extends AbstractRestoreActivity {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        mFile = new File(path);
        MyLogger.logI(CLASS_TAG, "onCreate with file " + mFile);
        init();
    }
    ...
    public void onRequestPermissionsResult(
        ...
        if (mShouldFinish) {
            ...
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    Utils.exitLockTaskModeIfNeeded(PersonalDataRestoreActivity.this);
                    finish();
                }
                ...
                dialog = ResultDialog.createResultDlg(this, R.string.restore_result, args,
                        new OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                MyLogger.logD(CLASS_TAG, "Restore result clicked");
                                if (mRestoreService != null) {
                                    mRestoreService.reset();
                                }
                                stopService();
