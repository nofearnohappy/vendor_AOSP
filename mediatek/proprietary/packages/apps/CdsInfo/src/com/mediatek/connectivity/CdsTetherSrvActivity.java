...
public class CdsTetherSrvActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mUsbRegexs = mConnMgr.getTetherableUsbRegexs();
        mWifiRegexs = mConnMgr.getTetherableWifiRegexs();
        mWifiRegexs = mConnMgr.getTetherableBluetoothRegexs();
    ...
    private void updateTetherSrvInfo() {
        ...
        Boolean isTetherSupported = mConnMgr.isTetheringSupported();
        ...
        tetherInterfaces = mConnMgr.getTetherableUsbRegexs();
        ...
        tetherInterfaces = mConnMgr.getTetherableWifiRegexs();
        tetherString = "";
        ...
        tetherInterfaces = mConnMgr.getTetherableBluetoothRegexs();
        tetherString = "";
    ...
    private void updateState() {
        ...
        available = (String[]) mConnMgr.getTetherableIfaces();
        tethered = mConnMgr.getTetheredIfaces();
        errored = mConnMgr.getTetheringErroredIfaces();
            ...
            for (String regex : mUsbRegexs) {
                if (s.matches(regex)) {
                    if (usbError == TETHER_ERROR_NO_ERROR) {
                        usbError = mConnMgr.getLastTetherError(regex);
                    }
                }
            }
        }
