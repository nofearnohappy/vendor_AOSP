...
/**
 * Class to dispose email and SIM related intent.
 */
public class InternalReceiver extends BroadcastReceiver {
    ...
    public void registerAll() {
        ...
        // Added by Bo Shang 2015-3-4 for L version.
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (null == strAction) {
            ...
            if (uid != -1) {
                ...
                || TelephonyIntents.ACTION_SUBINFO_CONTENT_CHANGE.equals(strAction)) {
            // Modified
            // by
            // Shaoying
            // Han
            ...
            EventDispatcher.dispatchEmailBackupEndEvent(new Event()
                    .put(IBackupAndRestoreListener.EMAIL_PATH,
                            intent.getStringExtra("path"))
                    .put(IBackupAndRestoreListener.EMAIL_FILE_NAME,
                            intent.getStringExtra("fileName"))
                    .put(IBackupAndRestoreListener.EMAIL_IS_SUCCESSFUL,
                            intent.getBooleanExtra("isSuccessful", false)));
        } else if (ACTION_END_EMAIL_RESTORE.equals(strAction)) {
            EventDispatcher
                    .dispatchEmailRestoreEndEvent(new Event()
                            .put(IBackupAndRestoreListener.EMAIL_PATH,
                                    intent.getStringExtra(IBackupAndRestoreListener.EMAIL_PATH))
                            .put(IBackupAndRestoreListener.EMAIL_FILE_NAME,
                                    intent
                                    .getStringExtra(IBackupAndRestoreListener.EMAIL_FILE_NAME))
                            .put(IBackupAndRestoreListener.EMAIL_IS_SUCCESSFUL,
                                    intent.getBooleanExtra(
                                            IBackupAndRestoreListener.EMAIL_IS_SUCCESSFUL,
                                            false)));
        }
    }
}
