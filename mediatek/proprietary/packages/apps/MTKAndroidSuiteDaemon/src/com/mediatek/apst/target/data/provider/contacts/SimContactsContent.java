...
//    public static final Uri CONTENT_URI_SIM4 = Uri.parse("content://icc/adn4");
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://icc/adn/subId/");
    
    public static final Uri CONTENT_URI_SIM1 = Uri.parse("content://icc/adn/subId/1");
    
    public static final Uri CONTENT_URI_SIM2 = Uri.parse("content://icc/adn/subId/2");
    
    public static final Uri CONTENT_URI_SIM3 = Uri.parse("content://icc/adn/subId/3");
    
    public static final Uri CONTENT_URI_SIM4 = Uri.parse("content://icc/adn/subId/4");
    /*
     * USIM URI added by mtk54043 2012.4.19
     */
    public static final Uri ICCUSIMURI = Uri.parse("content://icc/pbr/subId/");

    public static final Uri ICCUSIM1URI = Uri.parse("content://icc/pbr/subId/1");

    public static final Uri ICCUSIM2URI = Uri.parse("content://icc/pbr/subId/2");

    public static final Uri ICCUSIM3URI = Uri.parse("content://icc/pbr/subId/3");

    public static final Uri ICCUSIM4URI = Uri.parse("content://icc/pbr/subId/4");
