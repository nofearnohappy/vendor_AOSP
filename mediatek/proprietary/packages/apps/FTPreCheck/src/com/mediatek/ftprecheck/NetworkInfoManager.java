    ...
    private Handler mATCmdHander = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (ar.exception != null) {
                showToast(R.string.send_at_fail);
                return;
            }
            String[] data = null;
            ...
            case MSG_NW_INFO:
                ...
                FTPCLog.v(mTag, "data[0] is : " + data[0]);
                FTPCLog.v(mTag, "flag is : " + data[0].substring(FLAG_DATA_BIT));
                mFlag = Integer.valueOf(data[0].substring(FLAG_DATA_BIT));
                mFlag = mFlag | FLAG_OFFSET_BIT;
                FTPCLog.v(mTag, "flag change is : " + mFlag);
                if (mEmInfoEnum < 0) {
...
//                FTPCLog.v(mTag, "flag change is : " + mFlagLteDc);
//                if (mEmInfoEnum < 0) {
//                    throw new IllegalArgumentException("EM info enum invalid: " + mEmInfoEnum);
//                }
//                atCommand = new String[2];
//                atCommand[0] = "AT+EINFO=" + mFlagLteDc + "," + mEmInfoEnum + ",0";
//                atCommand[1] = "+EINFO";
//                sendATCommandLteDc(atCommand, MSG_NW_INFO_OPEN);//enable mEmInfoEnum type network report
//                break;
...
//            mLteDcPhone.registerForNetworkInfo(mUrcHandler, mUrcMsg, null);
//
...
//
//            //disable mEmInfoEnum type network report
//            mFlagLteDc = mFlagLteDc & FLAG_OR_DATA;//restore the flag
//            FTPCLog.v(mTag, "LTEDC close flag is :" + mFlagLteDc);
//            sendATCommandLteDc(
//                    new String[] {"AT+EINFO=" + mFlagLteDc + "," + mEmInfoEnum + ",1", ""},
//                    MSG_NW_INFO_CLOSE);
//        }
        ...
        FTPCLog.v(mTag, "The close flag is :" + mFlag);
...
//        FTPCLog.v(mTag, "sendATCommandLteDc :" + atCommand[0]);
...
//    }
    ...
    private void sendATCommand(String[] atCommand, int msg) {
        FTPCLog.v(mTag, "sendATCommand :" + atCommand[0]);
    ...
    private int getSimType() {
        //Now only concern PhoneConstants.SIM_ID_1
