...
public class AppsCorpus extends SingleSourceCorpus {
    ...
    public Drawable getCorpusIcon() {
        return getContext().getResources().getDrawable(R.drawable.corpus_icon_apps_mirrored);
    }

    @Override
    public Uri getCorpusIconUri() {
        return Util.getResourceUri(getContext(), R.drawable.corpus_icon_apps_mirrored);
    }
