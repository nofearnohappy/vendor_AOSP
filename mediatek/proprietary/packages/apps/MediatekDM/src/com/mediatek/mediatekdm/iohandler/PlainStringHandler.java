...
/**
 * PlainStringHandler is an abstract NodeIoHandler implementation which provides writable control
 * and a simple wrapper for straightforward String data access interface. Descendants of this class
 * should override readValue and writeValue methods to provide simple String read/write function for
 * PlainStringHandler. The interaction protocol (e.g. size inspection) is taken care of by
 * PlainStringHandler.
 *
 * @author mtk81226
 */
