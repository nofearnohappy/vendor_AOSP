...
public class MtvEngine implements AtvService.EventCallback {
     ...
     * @throws Exception
     */
    public void startRecord(String path, long maxFileSize, Surface s) throws IllegalStateException, IOException {
     ...
     * @throws Exception
     */
    private synchronized boolean open() throws IOException, IllegalArgumentException,
    IllegalStateException, SecurityException, InterruptedException {
