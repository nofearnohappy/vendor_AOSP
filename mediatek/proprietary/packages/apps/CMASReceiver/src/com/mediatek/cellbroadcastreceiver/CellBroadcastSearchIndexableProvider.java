...
public class CellBroadcastSearchIndexableProvider extends SearchIndexablesProvider {
    ...
    public Cursor queryNonIndexableKeys(String[] projection) {
        ...
        boolean showCmasSettings = res.getBoolean(R.bool.show_cmas_settings);

        Object[] ref;

        // Show alert settings and CMAS categories for CMAS builds and developer mode.
        if (!enableDevSettings && !showCmasSettings) {
