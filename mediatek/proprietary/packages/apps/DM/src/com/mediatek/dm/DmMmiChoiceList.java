...
public class DmMmiChoiceList implements MmiChoiceList {
    ...
    private final int mType = DmConst.ServerMessage.TYPE_ALERT_1103_1104;
    ...
    public MmiResult display(MmiViewContext arg0, String[] arg1, int arg2, boolean arg3) {
        DmChoiceList.sViewContext = arg0;
        DmChoiceList.sStringArray = arg1;
        DmChoiceList.sSelected = arg2;
        DmChoiceList.sChecked = arg3;
        Intent intent = new Intent(DmService.getInstance(), DmNiInfoActivity.class);
        intent.putExtra(DmNiInfoActivity.EXTRA_TYPE, mType);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        DmService.getInstance().startActivity(intent);
        return MmiResult.OK;
