...
import com.mediatek.FMTransmitter.FMTransmitterFeatureOption;
...
public class FMTxEMActivityFunctionalTestCase extends
    ...
    private static final float SEARCH_GAP = FMTransmitterFeatureOption.IS_FM_50KHZ_SUPPORT ? 0.05f : 0.1f;
    private static final int BASE_NUMBER = FMTransmitterFeatureOption.IS_FM_50KHZ_SUPPORT ? 100 : 10; // use as to get the frequency
