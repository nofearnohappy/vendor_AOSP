...
public class FMTxEMActivity extends Activity implements OnClickListener {
    ...
    ProgressDialog mSearchDialog = null;
        ...
        private static final int MAX_LENGTH = FMTransmitterFeatureOption.IS_FM_50KHZ_SUPPORT  ? 6 : 5;
        ...
        private boolean bindFMTransmitterService() {
            // TODO Auto-generated method stub
        if (bindService((new Intent()).setClass(getApplicationContext(), FMTransmitterService.class),
