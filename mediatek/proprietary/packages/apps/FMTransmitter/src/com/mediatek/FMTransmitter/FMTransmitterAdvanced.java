...
public class FMTransmitterAdvanced extends Activity {
    ...
    private static final int MAX_FREQUENCY_LENGTH = FMTransmitterFeatureOption.IS_FM_50KHZ_SUPPORT ? 6 : 5;

    // Search parameters.
    private static final int SEARCH_CHANNEL_COUNT = 10;
    private static final int SEARCH_CHANNEL_DIRECTION = 0;
    private static final int SEARCH_CHANNEL_GAP = FMTransmitterFeatureOption.IS_FM_50KHZ_SUPPORT ? 5 : 1;
