...
public class RcseQuickContactBadge implements OnClickListener {
    private boolean mIsGroupAvator;
    private long mThreadId;
    private Context mContext;
    private QuickContactBadge mQuickContactBadge;

    public RcseQuickContactBadge(Context context) {
        mContext = context;

    }
    public RcseQuickContactBadge(Context context, AttributeSet attrs) {
        mContext = context;
        mQuickContactBadge.setOnClickListener(this);
    }

    public RcseQuickContactBadge(Context context, AttributeSet attrs, int defStyle) {
        mContext = context;
    }
