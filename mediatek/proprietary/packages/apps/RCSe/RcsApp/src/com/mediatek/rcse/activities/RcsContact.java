...
public final class RcsContact {
    ...
    /**
     * Instantiates a new rcs contact.
     *
     ...
     */
    public RcsContact(String displayName, String number, String sortKey,
            Long phoneId, short contactId) {
        mDisplayName = displayName;
        mNumber = number;
        mSortKey = sortKey;
        mPhoneId = phoneId;
    ...
    public boolean equals(Object object) {
        if (object instanceof RcsContact) {
            return this.mNumber != null
                    && ((RcsContact) object).mNumber != null
