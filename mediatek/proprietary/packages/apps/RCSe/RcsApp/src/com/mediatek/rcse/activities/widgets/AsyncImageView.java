...
/**
 * The Class AsyncImageView.
 */
public class AsyncImageView extends ImageView {

    public static final String TAG = "AsyncAvatarView";
    private boolean mIsGrey = false;
    private AvatarViewWorker mAvatarViewWorker = new AvatarViewWorker(mContext,
            this);

    /**
     * Instantiates a new async image view.
     *
    ...
    /**
     * Sets the async contact.
     *
     * @param number the number
     * @param isGrey the is grey
     */
