...
public class FileTransferCapabilityManager {
     ...
     */
    public static void setFileTransferCapability(Context context,
            boolean ftCapability) {
        Logger.d(TAG, "setFileTransferCapability() ftCapability is "
                + ftCapability);
        final ExchangeMyCapability exchangeMyCapability = ExchangeMyCapability
                .getInstance(context);
        if (null == exchangeMyCapability) {
            Logger.e(TAG,
                    "setFileTransferCapability() ExchangeMyCapability instance is null");
            return;
        }
    ...
    public static boolean isFileTransferCapabilitySupported() {
        ...
        Logger.d(TAG,
                "isFileTransferCapabilitySupported() exit, ftCapability is "
                        + ftCapability);
        return ftCapability;
    }
    ...
    private static class SdcardHelper {
        ...
        public static boolean isSdcardSupportedFileTransfer() {
            ...
            Logger.d(TAG, "isSdcardSupportedFileTransfer() isSupported is "
                    + isSupported);
            return isSupported;
        }

        /**
         * Checks if is sdcard exist.
         *
         * @return true, if is sdcard exist
         */
