...
public class PageAdapter extends BaseAdapter {
    ...
    private final HashMap<Integer, OnClickListener> mListenerMap = 
    ...
    /**
     * Defined a listener to notify all the observer the specify emotion item is
     * selected.
     */
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        imageView.setLayoutParams(new GridView.LayoutParams(
                ChatFragment.EMOTION_ICON_WIDTH,
        ...
        if (listener == null) {
            listener = new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        int index = mPage * ChatFragment.ITEMS_PER_PAGE
                                + position;
                        mListener.onEmotionItemSelectedListener(
                                PageAdapter.this, index);
                    }
                }
            };
