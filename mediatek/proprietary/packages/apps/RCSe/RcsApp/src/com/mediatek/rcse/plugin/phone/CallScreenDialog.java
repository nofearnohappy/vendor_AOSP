...
public class CallScreenDialog {
    ...
    /**
     * Instantiates a new call screen dialog.
     *
    ...
    public void setPositiveButton(String displayString,
        ...
        Logger.v(TAG, "setPositiveButton(), displayString = "
                + displayString + ",postiveListener = "
                + postiveListener);
    ...
    public void dismissDialog() {
        ...
        if (mAlertDialog != null && mAlertDialog.isShowing()) {
            ...
            mAlertDialog.dismiss();
				...
				Logger.e(TAG, "dismissDialog is Exception");
				e.printStackTrace();
			}
        } else {
     ...
     * set Cancel Listener.
     *
     * @param listener the new cancel listener
     */
