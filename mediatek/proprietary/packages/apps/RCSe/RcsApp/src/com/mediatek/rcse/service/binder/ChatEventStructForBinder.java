...
public class ChatEventStructForBinder implements Parcelable {
    ...
    /**
     * Instantiates a new chat event struct for binder.
     *
     * @param info the info
     * @param relatedInfo the related info
     * @param dt the dt
     */
    public ChatEventStructForBinder(int info,
            List<String> relatedInfo, String dt) {
        mInformation = info;
    ...
    public String toString() {
        return TAG + "information is " + mInformation
                + " relatedInformation is " + mRelatedInformation
                + " date is " + mDate;
    }
    /* (non-Javadoc)
