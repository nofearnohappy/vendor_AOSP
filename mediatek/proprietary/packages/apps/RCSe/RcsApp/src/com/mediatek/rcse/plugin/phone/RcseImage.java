...
public final class RcseImage {
    ...
    private int getDegreesRotated() {
        ...
        Logger.v(TAG, "getDegreesRotated exit with degreesRotated: "
                + degreesRotated);
    ...
    private int computeSampleSize(BitmapFactory.Options options,
        ...
        int roundedSize1;
        int roundedSize2;
        roundedSize1 = (int) Math.ceil(Math.sqrt(w * h
                / maxNumOfPixels));
        w = (w > h) ? h : w;
        roundedSize2 = (int) Math.floor(w / minSideLength);
        return (roundedSize1 > roundedSize2) ? roundedSize1
                : roundedSize2;
    }
    /**
     * Close silently.
     ...
     * @return the bitmap
     */
    private Bitmap makeBitmap(int minSideLength, int maxNumOfPixels,
        ...
        try {
            ...
            if (tempOptions.mCancel || tempOptions.outWidth == -1
                    || tempOptions.outHeight == -1) {
                return null;
            }
            tempOptions.inSampleSize = computeSampleSize(tempOptions,
            ...
            return BitmapFactory.decodeFileDescriptor(fd, null,
                    tempOptions);
     ...
     * @return the bitmap
     */
    public Bitmap fullSizeBitmap(int maxNumberOfPixels,
        ...
        try {
            pfdInput = ParcelFileDescriptor.open(new File(path),
        ...
        Bitmap bitmap = null;
        bitmap = makeBitmap(minSideLength, maxNumberOfPixels, null,
                null, pfdInput, null);
    ...
    /**
     * Gets the proper window size.
     *
     * @return the proper window size
     */
    ...
    private Bitmap rotate(final Bitmap b, int degrees) {
        ...
        if (degrees != 0 && bitmap != null) {
            ...
            try {
                Bitmap bitmapRotated = Bitmap.createBitmap(bitmap, 0,
                        0, bitmap.getWidth(), bitmap.getHeight(), m,
                        true);
