 ...
 * @author jexa7410
 */
public class TerminatingOne2OneStandAloneChatSession extends OneOneChatSession {
	/**
     * The logger
     */
	 ...
	 */
	public TerminatingOne2OneStandAloneChatSession(ImsService parent, SipRequest invite) {
	...
	public void run() {
		try {
            ...
            if ((ChatUtils.isImdnDeliveredRequested(getDialogPath().getInvite())) ||
                ...
                if (msgId != null && !(LauncherUtils.supportOP01())) {
			...
			if(true){ //Auto accept always for Large mode
                if (logger.isActivated()) {
