 ...
 * @author jexa7410
 */
public class OriginatingStandAloneFileSharingSession extends ImsFileSharingSession implements MsrpEventListener {
	/**
	 * Boundary tag
	 */
	 ...
	 */
	public OriginatingStandAloneFileSharingSession(ImsService parent, MmContent content, String contact, byte[] thumbnail) {
