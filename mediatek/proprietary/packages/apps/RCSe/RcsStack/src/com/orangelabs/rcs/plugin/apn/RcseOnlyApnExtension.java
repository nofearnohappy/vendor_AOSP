...
/**
 * This class defined to implement the function interface of IRcseOnlyApnExt,
 * and achieve the main function here
 */
public class RcseOnlyApnExtension extends ContextWrapper implements IRcseOnlyApnExt {
        ...
        public void onReceive(Context context, Intent intent) {
           ...
           //     Logger.e(TAG, "onReceive()-current RCS-e only APN status is " + status);
            ...
            //        Logger.d(TAG, "notifyListeners() notify the listener");
                    listener.OnRcseOnlyApnStateChanged();
                }
            }
        }
    }
