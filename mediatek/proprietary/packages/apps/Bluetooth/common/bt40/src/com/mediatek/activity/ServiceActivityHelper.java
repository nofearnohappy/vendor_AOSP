...
public class ServiceActivityHelper<ServiceInterface> {
    ...
    public boolean bindService(Context context) {
        ...
        this.isServiceAvailable = false;
        Intent intent = new Intent(this.serviceActivity.getServiceAction());
        intent.setClassName(mPackageName, mServiceClassName);

        BtLog.d("Helper PackageName = " + mPackageName + "ServiceClassName = " + mServiceClassName);
        
        boolean res = context.bindService(intent, serviceConn,
    ...
    public void setComponentName(String packageName, String serviceClassName) {
    ...
    public Dialog createBusyDialog(int id, Context context) {
        ...
        {
            BtLog.d("createBusyDialog() new ProgressDialog is null");
        }
