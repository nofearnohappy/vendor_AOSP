...
public class BluetoothSimapService extends Service {
	...
	//private final static int MAX_SIM_NUM = TelephonyManager.getPhoneCount();
    ...
    private synchronized void setState(int state, int result) {
        if (state != mState) {
				...
				)
			{
				...
				bpm_intent.putExtra(BluetoothProfileManager.EXTRA_PROFILE, BluetoothProfileManager.Profile.SIMAP);
				int bpm_state;
            ...
            intent.putExtra(BluetoothProfileManager.EXTRA_PROFILE, BluetoothProfileManager.Profile.SIMAP);
    ...
    private void onAuthorizeInd(String addr) {
