...
public class Email{
	...
	public static final Uri MESSAGE_BODY_HTML_URI = Uri.parse(CONTENT_URI + "/bodyHtml");
	public static final Uri MESSAGE_BODY_TEXT_URI = Uri.parse(CONTENT_URI + "/bodyText");
	/*************/
