...
public class MessageListRequest {
        ...
        public static final int MSG_PARAM_SUBJECT = (1 << 0); /* subject  REQUIRED*/
        
        public static final int MSG_PARAM_DATE_TIME = (1 << 1); /* date time REQUIRED */
        
        public static final int MSG_PARAM_SENDER_NAME = (1 << 2);  /* Sender name */
        
        public static final int MSG_PARAM_SENDER_ADDR = (1 << 3);   /* Sender addressing*/
        
        public static final int MSG_PARAM_REC_NAME = (1 << 4);  /* Recipient name */
        
        public static final int MSG_PARAM_REC_ADDR = (1 << 5);  /* Recipient addressing REQUIRED */
        
        public static final int MSG_PARAM_TYPE = (1 << 6);  /* Type REQUIRED */
        
        public static final int MSG_PARAM_SIZE = (1 << 7);  /* Size REQUIRED */
        
        public static final int MSG_PARAM_REC_STATUS = (1 << 8);    /* Reception status REQUIRED */
        
        public static final int MSG_PARAM_TEXT = (1 << 9);  /* Text */
        
        public static final int MSG_PARAM_ATTACH_SIZE = (1 << 10);  /* Attachment size REQUIRED */
        
        public static final int MSG_PARAM_PRIORITY = (1 << 11); /* Priority */
        
        public static final int MSG_PARAM_READ = (1 << 12); /* Read */
        
        public static final int MSG_PARAM_SENT = (1 << 13); /* Sent */
        
        public static final int MSG_PARAM_PROTECTED = (1 << 14);    /* Protected */
        
        public static final int MSG_PARAM_REPLYTO_ADDR = (1 << 15); /* Replyto addressing */

        public static final int MSG_PARAM_DEFAULT_REQUIRED = (MSG_PARAM_SUBJECT | MSG_PARAM_DATE_TIME | MSG_PARAM_SENDER_NAME | MSG_PARAM_REC_ADDR | 
                                                        MSG_PARAM_TYPE | MSG_PARAM_SIZE | MSG_PARAM_ATTACH_SIZE);
		...
		*/
		...
		public int getMask () {
			if (mMask == 0) {
				mMask = MSG_PARAM_DEFAULT_REQUIRED;
			}
			return mMask;
		}
