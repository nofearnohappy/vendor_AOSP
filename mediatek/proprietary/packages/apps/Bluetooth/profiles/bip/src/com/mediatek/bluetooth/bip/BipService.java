...
//sync with BluetoothProfile.java
	...
	@Override
	public void run() {		
	        Log.v("@M_" + TAG, "Database Query Thread");
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		Log.v("@M_" + TAG, "ACTION_MEDIA_EJECT: curStorage = "+curStorage.getAbsolutePath()+"path = "+path.getPath());
    ...
    private BroadcastReceiver nReceiver = new BroadcastReceiver() {
		...
		Log.v("@M_" + TAG, "Receive image task");
		Bundle bundle = intent.getExtras();
		Intent mIntent = bundle.getParcelable("Intent");
		if(mIntent == null){
			Log.v("@M_" + TAG, "mIntent == null");
		}
...
*/
    ...
    private class BipiContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            Log.v("@M_" + TAG, "BipiContentObserver received notification: bipi state=" + mBipiState );
            if (mBipiState == BIPI_DISABLED || mBipiState == BIPI_DISABLING) {
		if(!mHasStarted){
			Log.w("@M_" + TAG, "Service does not start");
			return;
		}
    ...
    private final Handler mCallbackHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_ENABLE_RESULT: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "enable error, disable bipi");
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_DISABLE_RESULT: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
		    ...
		    releaseWakeLock(initiatorWakeLock);
                ...
                {
                  Log.v("@M_" + TAG, "MSG_ON_BIPI_OBEX_AUTHREQ:" + msg.arg2);
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_CONNECT_CNF: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "connect error, disable bipi");
                        mBipiState = BIPI_DISABLING;
                        mBipServer.bipiDisable();
                    }
                }
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_GET_CAPABILITYT_CNF: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "get capability error, disconnect bipi");
                        ...
                        Log.v("@M_" + TAG, "get capability success");

                        
                        Capability remoteCapaObj = (Capability)msg.obj;

                        Log.v("@M_" + TAG, "Version: " + remoteCapaObj.PreferFormat.Version +
                        ...
                        for(int i=0; i<remoteCapaObj.NumImageFormats; i++)
                            Log.v("@M_" + TAG, "SupEncoding: " + remoteCapaObj.ImageFormats[i].Encoding +
                        ...
                        if (compareImgFormat(remoteCapaObj, mInitiatorImageObject)) {
                            ...
                            Log.w("@M_" + TAG, "Responder dosen't support this format");
                ...
                case MSG_ON_BIPI_IMAGE_PUSH_START:
                {
                    ...
                    Log.v("@M_" + TAG, "BIPI_IMAGE_PUSH_START");
                }
                break;
                case MSG_ON_BIPI_PROGRESS:
                {
                    Log.v("@M_" + TAG, "BIPI_PROGRESS_IND: " + msg.arg1);
                    Log.v("@M_" + TAG, "progress: " + msg.arg2);
                    if (mBipiState == BIPI_PUSH_IMG) {
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_PUSH_CNF: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "push error, disconnect bipi");
                        if (mBipiState != BIPI_PUSH_IMG) {
                            Intent bIntent = new Intent( BipInitPushConfirmation.ACTION_TIMEOUT );
                            sendBroadcast(bIntent);
                        }
                        ...
                        Log.v("@M_" + TAG, "image handler: " + msg.arg2);
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_THUMBNAIL_REQ");
                    Log.v("@M_" + TAG, "image handler: " + msg.arg2);
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_THUMBNAIL_PUSH_START");
                }
                break;
                case MSG_ON_BIPI_THUMBNAIL_PUSH:
                {
                    Log.v("@M_" + TAG, "BIPI_THUMBNAIL_PUSH_CNF: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "push thumbnail error, disconnect bipi");
                        //for unsupporting format, it retruns fail even the transmission is success.
                        createBipNotification( 0, BipTransmitting.DIALOG_TRANSMISSION_FAIL);
                    }
                    else{
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_DISCONNECT_RESULT: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "disconnect error, disable bipi");
                    }
                    //mBipServer.bipiDisable();
                    //mBipiState = BIPI_DISABLING;
                ...
                {
                    Log.v("@M_" + TAG, "BIPI_CANCEL_RESULT: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "cancel error, disconnecting...");
                    }
                }
                break;
                //BIPI end
                ...
                {
                    Log.v("@M_" + TAG, "BIPR_ENABLE_RESULT: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "enable error, disable bipr");
                ...
                {
                    Log.v("@M_" + TAG, "BIPR_DISABLE_RESULT: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "disable error");
                    }
		    ...
		    mBiprState = BIPR_CONNECTING;
                ...
                {
                    Log.v("@M_" + TAG, "BIPR_CONNECT_CNF: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "connect error, disable bipi");
                        mBipServer.biprDisable();
                        mBiprState = BIPR_DISABLING;
                ...
                case MSG_ON_BIPR_GET_CAPABILITY_REQ:
                {
                    ...
                    Log.v("@M_" + TAG, "MSG_ON_BIPR_GET_CAPABILITY");
                ...
                {
                    Log.v("@M_" + TAG, "MSG_ON_BIPR_CAPABILITY_RES");
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "issue capability response error");
                    }
                    else {
                ...
                {
                    Log.v("@M_" + TAG, "MSG_ON_BIPR_ACCESS_REQ");
			...
			if(mAlwaysAccept){
                ...
                {
                    Log.v("@M_" + TAG, "MSG_ON_BIPR_IMAGE_RECEIVE_START");
                ...
                {
                    Log.v("@M_" + TAG, "BIPR_PROGRESS_IND");
                    Log.v("@M_" + TAG, "object length: " + msg.arg1);
                    Log.v("@M_" + TAG, "progress: " + msg.arg2);
                ...
                {
                    Log.v("@M_" + TAG, "BIPR_RECEIVE_CNF: " + msg.arg1);
		    mCallbackHandler.removeMessages(MSG_ON_BIPR_RECEIVE);
		    ...
		    mCallbackHandler.sendEmptyMessageDelayed(MSG_ON_BIPR_ALWAYS_ACCEPT, 20000);
                    if ( msg.arg1 != 0 ){
                        ...
                        Log.e("@M_" + TAG, "receive error, disconnect bipr");
                        mBiprState = BIPR_DISCONNECTING;
                        mBipServer.biprDisconnect();
                    }
                    else{
                ...
                case MSG_ON_BIPR_THUMBNAIL_RECEIVE_START:
                {
                    ...
                    Log.v("@M_" + TAG, "MSG_ON_BIPR_THUMBNAIL_RECEIVE_START");
                }
                break;
                case MSG_ON_BIPR_THUMBNAIL_RECEIVE:
                {
                    Log.v("@M_" + TAG, "BIPR_THUMBNAIL_RECEIVE_CNF: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "receive error, disconnect bipr");
                    }
                ...
                {
                    Log.v("@M_" + TAG, "BIPR_DISCONNECT_RESULT: " + msg.arg1);
                    if ( msg.arg1 != 0 ){
                        Log.e("@M_" + TAG, "disconnect error, disable bipr");
                    }
                    //mBipServer.biprDisable();
                    //mBiprState = BIPR_DISABLING;
                    if (mBiprNotificationId < NOTIFICATION_ID_BIP_END - 1) {
		    ...
		    releaseWakeLock(responderWakeLock);
                ...
                {
                    Log.v("@M_" + TAG, "MSG_ON_BIPR_ALWAYS_ACCEPT");
		    mAlwaysAccept = false;
                }
                break;
            }//switch end
    ...
    public void onCreate() {
        super.onCreate();
        Log.v("@M_" + TAG, "BipService onCreate");
			 ...
			 btAdapter.getState() == BluetoothAdapter.STATE_ON))
        {
            ...
            Log.v("@M_" + TAG, "Creating BIPI Service......");
            mHasStarted = true;
            mBipiState = BIPI_DISABLED;
            mBiprState = BIPR_DISABLED;
...
mBipServer.setRecvPath(SystemUtils.getReceivedFilePath(mContext)); // 20120626 added by mtk71255 for avoiding duplicated name file override
               ...
               Log.e("@M_" + TAG, "ERROR, BIPI has already created");
               stopSelf();
            }
        }
        else
        {
            ...
            Log.e("@M_" + TAG, "DISABLE before ENABLE");
            stopSelf();
        }
    }
    ...
    public IBinder onBind(Intent intent) {
        Log.v("@M_" + TAG, "BipService onBind");

        String action = intent.getAction();
        Log.v("@M_" + TAG, " onBind() action = " + action);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.v("@M_" + TAG, "BipService onStartCommand");
    ...
    public void onDestroy() {
        Log.v("@M_" + TAG, "BipService onDestroy");
		releaseWakeLock(initiatorWakeLock);
		releaseWakeLock(responderWakeLock);
    ...
    private void parseIntent(final Intent intent) {
        ...
        if ( null == action ) {
            ...
            Log.v("@M_" + TAG, "ACTION_BIPI_AUTH_INFO");
            ...
            Log.v("@M_" + TAG, "ACTION_BIPI_CANCEL");
            mCallbackHandler.removeMessages(MSG_ON_BIPI_PUSH);
            mBipiState = BIPI_DISCONNECTING;
            mBipServer.bipiDisconnect(mInitiatorRemoteBtAddr);
            //mJobCanceled = true;
           ...
           Log.e("@M_" + TAG, "ACTION_CANCEL_PENDING");
        }
        else if (action.equals(ACTION_BIP_DISABLE)) {
            Log.v("@M_" + TAG, "ACTION_BIP_DISABLE");
	    ...
	    mAlwaysAccept = intent.getBooleanExtra("alwaysAccept",false);
            Log.v("@M_" + TAG, "ACTION_RECEIVE_ACCEPT and always Accept is "+ mAlwaysAccept);
			/*
            mCallbackHandler.removeMessages(MSG_ON_BIPR_RECEIVE);
            ...
            */
            ...
            Log.v("@M_" + TAG, "ACTION_RECEIVE_REJECT");
            mCallbackHandler.removeMessages(MSG_ON_BIPR_RECEIVE);
            mBiprState = BIPR_DISCONNECTING;
            mBipServer.biprDisconnect();
        } 
    ...
    private final void closeService() {
        Log.v("@M_" + TAG, "BipiService closeService");
        mHasStarted = false;
        if (stopSelfResult(mStartId)) {
            Log.v("@M_" + TAG, "successfully stopped Bipi service");
        }
    }
    ...
    private void executeJob() {
        ...
        Log.v("@M_" + TAG, "enter executeJob,Environment.getExternalStorageState() = "+Environment.getExternalStorageState());
	
	if( false == Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) ){
		Log.v("@M_" + TAG, "SD card unmounted");
		Toast.makeText( mContext, R.string.bt_bip_toast_storage_unmounted, Toast.LENGTH_LONG ).show();
...
*/
	...
	try {
		...
		Log.e("@M_" + TAG, "mDatabaseQueryThread close error.");
	}


        if ( null == mCursor ) {
            Log.e("@M_" + TAG, "mCursor is null");
        } 
            ...
            Log.v("@M_" + TAG, "ID: " + Id );
            Log.v("@M_" + TAG, "Uri: " + mUri );
            Log.v("@M_" + TAG, "Addr: " + mInitiatorRemoteBtAddr );
            Log.v("@M_" + TAG, "Name: " + mInitiatorRemoteDevName );
            ...
            Log.w("@M_" + TAG, "Job table is empty");
            mCursor.close();
            mBipiState = BIPI_DISABLING;
            mBipServer.bipiDisable();
			//releaseWakeLock();
        }
        Log.v("@M_" + TAG, "leave executeJob");
    ...
    private void createBipNotificationT(long sent, int descriptionType, int type) {
        ...
        Log.v("@M_" + TAG, "createBipNotification");

        if ( descriptionType == NOTIFICATION_INCOMING_REQ ) {

            Log.v("@M_" + TAG, "NOTIFICATION_INCOMING_REQ");
            String title = null;
            ...
            Log.v("@M_" + TAG, "RemoteDevName:" +  mResponderRemoteDevName + "\tfileName:" + mResponderObjectName + "\tfileSize:" + sent );
        ...
        if ( descriptionType == NOTIFICATION_PENDING_JOB ) {
            ...
            Log.v("@M_" + TAG, "NOTIFICATION_PENDING_JOB");
            int nId = (int)sent;
            ...
            Log.v("@M_" + TAG, "mDialogType:" + BipTransmitting.DIALOG_PENDING_JOB + "\tfileName:" + fileName);
	    ...
	    if(mInitiatorObjectSize == null){
            	Log.w("@M_" + TAG, "mInitiatorObjectSize is null");
		total = 0;
	    }else
        ...
        if ( null == bIntent ) {
            Log.e("@M_" + TAG, "broadcast intent is null");
            return;
        }
        ...
        switch ( descriptionType ) {
            case NOTIFICATION_TRANSMIT_PROCESSING:
            {
                ...
                Log.v("@M_" + TAG, "NOTIFICATION_TRANSMIT_PROCESSING");
                Log.v("@M_" + TAG, "mDialogType:" + BipTransmitting.DIALOG_TRANSMISSION_PROCESSING +
...
*/
            ...
            case NOTIFICATION_TRANSMIT_SUCCESS:
            {
                ...
                Log.v("@M_" + TAG, "NOTIFICATION_TRANSMIT_SUCCESS");
                Log.v("@M_" + TAG, "mDialogType:" + BipTransmitting.DIALOG_TRANSMISSION_SUCCESS +
                       "\tmPercentage:" + percentage + "\tfileName:" + fileName);
            ...
            case NOTIFICATION_TRANSMIT_FAIL:
            {
                ...
                Log.v("@M_" + TAG, "NNOTIFICATION_TRANSMIT_FAIL");
                Log.v("@M_" + TAG, "mDialogType:" + BipTransmitting.DIALOG_TRANSMISSION_FAIL +
                       "\tmPercentage:" + percentage + "\tfileName:" + fileName);
            ...
            case NOTIFICATION_RECEIVE_PROCESSING:
            {
                ...
                Log.v("@M_" + TAG, "NOTIFICATION_RECEIVE_PROCESSING");
                Log.v("@M_" + TAG, "mDialogType:" + BipTransmitting.DIALOG_RECEIVE_PROCESSING +
                       "\tmPercentage:" + percentage + "\tfileName:" + fileName);
...
*/
            ...
            case NOTIFICATION_RECEIVE_SUCCESS:
            {
                ...
                Log.v("@M_" + TAG, "NOTIFICATION_RECEIVE_SUCCESS");
                Log.v("@M_" + TAG, "mDialogType:" + BipTransmitting.DIALOG_RECEIVE_SUCCESS +
                       "\tmPercentage:" + percentage + "\tfileName:" + fileName);
            ...
            case NOTIFICATION_RECEIVE_FAIL:
            {
                ...
                Log.v("@M_" + TAG, "NNOTIFICATION_RECEIVE_FAIL");
                Log.v("@M_" + TAG, "mDialogType:" + BipTransmitting.DIALOG_RECEIVE_FAIL +
                       "\tmPercentage:" + percentage + "\tfileName:" + fileName);
        ...
        Log.v("@M_" + TAG, "SEND broadcast to DIALOG");
        sendBroadcast(bIntent);
