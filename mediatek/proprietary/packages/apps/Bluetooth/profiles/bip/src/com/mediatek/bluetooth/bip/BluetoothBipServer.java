...
public class BluetoothBipServer {
    ...
    class BipListener extends Thread {
        ...
        public void run() {
            ...
            Log.i("@M_" + TAG, "[BIP Server] listen thread run......");
            BluetoothBipServer.this.startListenNative();
            Log.i("@M_" + TAG, "[BIP Server] listen thread stopped......");
        }
...
*/
    ...
    public boolean enable() {
        ...
        { 
            Log.e("@M_" + TAG, "mNativeData has been initialized");
        } 
        Log.i("@M_" + TAG, "-enable");
        return true;
    }
    ...
    public void disable(){
        ...
        if (mNativeData != 0 )
        {
            try {
                ...
                Log.w("@M_" + TAG, "BipServer mListener close error");
            }
        ...
        {
            Log.e("@M_" + TAG, "mNativeData has been cleaned");
        }
        Log.i("@M_" + TAG, "-disable");
    }
...
----------------------------------------*/
    ...
    public boolean bipiGetCapabilityReq(String btaddr) {
        Log.i("@M_" + TAG, "+bipiGetCapabilityReq");
    ...
    public boolean bipiPushThumbnail(String btaddr, BipImage object){
        Log.i("@M_" + TAG, "+bipiPushThumbnail");
    ...
    {
        Log.i("@M_" + TAG, "+biprGetCapabilityRsp");
	...
	Log.i("@M_" + TAG, "mReceivedFileName:" + mReceivedFileName);
...
----------------------------------------*/
    ...
    //should there are two handlers? One for server and one for client
        switch(event)
        {
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_ENABLE_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_ENABLE_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPI_ENABLE, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_DISABLE_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_DISABLE_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPI_DISABLE, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_OBEX_AUTHREQ");
                if( parameters[0].equals("1") )
                {
                    Log.i("@M_" + TAG, "UserID required");
                }
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_CONNECT_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_CONNECT_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPI_CONNECT, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_GET_CAPABILITY_SUCCESS");
...
/*
                Log.i("@M_" + TAG, "Version: " + capaObj.PreferFormat.Version);
                Log.i("@M_" + TAG, "Encoding: " + capaObj.PreferFormat.Encoding);
                Log.i("@M_" + TAG, "Width: " + capaObj.PreferFormat.Width);
                Log.i("@M_" + TAG, "Height: " + capaObj.PreferFormat.Height);
                Log.i("@M_" + TAG, "Width2: " + capaObj.PreferFormat.Width2);
                Log.i("@M_" + TAG, "Height2: " + capaObj.PreferFormat.Height2);
                Log.i("@M_" + TAG, "Size: " + capaObj.PreferFormat.Size);
                Log.i("@M_" + TAG, "Transform: " + capaObj.PreferFormat.Transform);
                Log.i("@M_" + TAG, "NumFormats: " + capaObj.NumImageFormats );
*/
...
/*
                    Log.i("@M_" + TAG, "SupEncoding: " + capaObj.ImageFormats[i].Encoding);
                    Log.i("@M_" + TAG, "SupWidth: " + capaObj.ImageFormats[i].Width);
                    Log.i("@M_" + TAG, "SupHeight: " + capaObj.ImageFormats[i].Height);
                    Log.i("@M_" + TAG, "SupWidth2: " + capaObj.ImageFormats[i].Width2);
                    Log.i("@M_" + TAG, "SupHeight2: " + capaObj.ImageFormats[i].Height2);
                    Log.i("@M_" + TAG, "SupSize: " + capaObj.ImageFormats[i].Size);
*/
                }
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_GET_CAPABILITY_FAIL");
                int cnfCode = -1;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_IMAGE_PUSH_START");
                mCallback.obtainMessage(BipService.MSG_ON_BIPI_IMAGE_PUSH_START, 0, 0).sendToTarget();
            }
            break;
            case BIP_INITIATOR_PROGRESS:
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_PROGRESS");
                Log.i("@M_" + TAG, "Sending Length: " + parameters[0]);
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_IMAGE_PUSH_SUCCESS");

                Log.i("@M_" + TAG, "Image Handle: " + parameters[0]);
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_IMAGE_PUSH_FAIL");
                int cnfCode = -1;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_THUMBNAIL_REQ");
                Log.i("@M_" + TAG, "Image Handle: " + parameters[0]);
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_THUMBNAIL_PUSH_START");
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_THUMBNAIL_PUSH_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_THUMBNAIL_PUSH_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPI_THUMBNAIL_PUSH, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_DISCONNECT_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_DISCONNECT_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPI_DISCONNECT, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_CANCEL_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_INITIATOR_CANCEL_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPI_CANCEL, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_ENABLE_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_ENABLE_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPR_ENABLE, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_DISABLE_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_DISABLE_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPR_DISABLE, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_AUTH_REQ");
                Log.i("@M_" + TAG, "RemoteDevName: " + parameters[0]);
                Log.i("@M_" + TAG, "RemoteBtAddr: " + parameters[1]);
                mCallback.obtainMessage(BipService.MSG_ON_BIPR_AUTH_REQ, 0, 0, parameters).sendToTarget();
            }
            break;
            case BIP_RESPONDER_OBEX_AUTHREQ:
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_OBEX_AUTHREQ");
                if( parameters[0].equals("1") )
                {
                    Log.i("@M_" + TAG, "UserID required");
                }
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_CONNECT_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_CONNECT_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPR_CONNECT, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {  
                Log.i("@M_" + TAG, "BIP_RESPONDER_GET_CAPABILITY_REQ");
            ...
            {  
                Log.i("@M_" + TAG, "BIP_RESPONDER_CAPABILITY_RES_SUCCESS");
                int cnfCode = 0;
		...
		mReceivedFileName = parameters[0];
                Log.i("@M_" + TAG, "BIP_RESPONDER_ACCESS_REQ");
                Log.i("@M_" + TAG, "fileName: " + parameters[0]);
                Log.i("@M_" + TAG, "fileSize: " + parameters[1]);
                mPreReceiveLength = 0;
                mCurReceiveLength = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_IMAGE_RECEIVE_START");
                mCallback.obtainMessage(BipService.MSG_ON_BIPR_IMAGE_RECEIVE_START, 0, 0).sendToTarget();
            }
            break;
            case BIP_RESPONDER_PROGRESS:
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_PROGRESS");
                Log.i("@M_" + TAG, "Object Length: " + parameters[1]);
                ...
                Log.i("@M_" + TAG, "Receiving Length: " + parameters[0]);
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_IMAGE_RECEIVE_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_IMAGE_RECEIVE_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPR_RECEIVE, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_THUMBNAIL_RECEIVE_START");
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_THUMBNAIL_RECEIVE_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_THUMBNAIL_RECEIVE_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPR_THUMBNAIL_RECEIVE, cnfCode, 0).sendToTarget();
            }
            break;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_DISCONNECT_SUCCESS");
                int cnfCode = 0;
            ...
            {
                Log.i("@M_" + TAG, "BIP_RESPONDER_DISCONNECT_FAIL");
                int cnfCode = -1;
                mCallback.obtainMessage(BipService.MSG_ON_BIPR_DISCONNECT, cnfCode, 0).sendToTarget();
            }
            break;
            default:
                Log.e("@M_" + TAG, "UN-KNOWN EVENT");
        }//switch end
    } //onCallback end
	// 20120627 added by mtk71255 for avoiding duplicated name file override
