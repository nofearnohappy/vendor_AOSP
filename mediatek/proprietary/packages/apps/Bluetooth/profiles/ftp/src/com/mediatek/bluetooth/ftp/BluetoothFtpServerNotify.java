...
public class BluetoothFtpServerNotify extends Activity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent intent2;
		intent2 = new Intent("com.mediatek.bluetooth.ftp.IBluetoothFtpServerNotify");
		intent2.setComponent( new ComponentName("com.mediatek.bluetooth", "com.mediatek.bluetooth.ftp.BluetoothFtpService") );
		ret = bindService( intent2, 
	...
	private void sendAuthResult(boolean res) {
		...
		try {
			...
			mServerNotify.authResult(res);
			    ...
			    Log.e(TAG, "authResult() succes but fail to notify.");    
			}
