...
public class XMLParsingThread extends Thread {
	...
	public void run() {
		...
		try {
			...
			fis = new FileInputStream(new File(mXMLFilePath));
...
class FtpObexXMLHandler extends DefaultHandler {
	...
	private String getFormattedDate(String date) {
		...
		try {
			...
			Log.w(TAG, "Modification date parsing failed. Set as default: " + iobe);

		} catch (NullPointerException npe) {
			Log.w(TAG, "Modification date parsing failed. Set as default: " + npe);
		}		
