 ...
 ********************************************************************************************/
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent intent = new Intent(IBluetoothFtpClient.class.getName());
		intent.setComponent(intent.resolveSystemService(getApplicationContext().getPackageManager(), 0));        
        
		if (!bindService(intent, mFtpClientConn, 0)) {
