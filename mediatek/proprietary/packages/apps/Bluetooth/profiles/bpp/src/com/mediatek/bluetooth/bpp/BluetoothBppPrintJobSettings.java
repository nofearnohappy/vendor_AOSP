...
public class BluetoothBppPrintJobSettings
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(ACTION_ATTR_UPDATE)) {
               ...
               {
                   Log.v("@M_" + TAG, "Exception");
                   BluetoothBppPrintJobSettings.this.finish();
               }
               else
               {
                   Log.v("@M_" + TAG, "updateAttr");
                   updateAttr();
               }
            }
        }
 ...
 //       String [] qualitySetting = {"Draft", "Normal", "High"};
        ...
        if ( null == mPaperSize ) {
            Log.e("@M_" + TAG, "PaperSize preference is null");
        }
        else {
        ...
        if ( null == mNumberOfCopies ) {
            Log.e("@M_" + TAG, "NumberOfCopies preference is null");
        }
        else { 
            if ( 1 == mMaxCopies ) {
        ...
        if ( null == mSidesSetting ) {
            Log.e("@M_" + TAG, "SideSetting preference is null");
        }
        else {
        ...
        if ( null == mPagesPerSheet ) {
            Log.e("@M_" + TAG, "PagesPerSheet preference is null");
        }
        else {
        ...
        if ( null == mOrientation ) {
            Log.e("@M_" + TAG, "Orientation preference is null");
        }
        else {
        ...
        if ( null == mQualitySetting ) {
            Log.e("@M_" + TAG, "QualitySetting preference is null");
        }
        else {
        ...
        if ( null == mGetDefaultValue ) {
            Log.e("@M_" + TAG, "Get Default Value button is null");
        }
        else {
        ...
        if ( null == mPrint ) {
            Log.e("@M_" + TAG, "Print button is null");
        }
        else {
    ...
    protected void onResume() {
        ...
        if ( null == printSettings ) {
            Log.v("@M_" + TAG, "share preferences is null");
        }
        else {
...
*/
    ...
    public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
        ...
        Log.v("@M_" + TAG, "onSharePreferenceChanged......");
    ...
    public void onClick(View v) {
        if (v == mGetDefaultValue) {
             Log.v("@M_" + TAG, "Start Bpp Manager to change printer !");
             ...
             Log.v("@M_" + TAG, "Start Bpp Manager to print !");
