...
*/
     ...
     */
    {
        ...
        s1.setOnItemSelectedListener(
                new OnItemSelectedListener() {
                    public void onItemSelected(
                    	...
                    	Log.d("@M_" + "MTKThermalManagerActivity", "Spinner1 OnItemSelectedListener.onItemSelected() position=" + position + " id=" + id + "\n");
                    	/**
                    ...
                    public void onNothingSelected(AdapterView<?> parent) {
                    	Log.d("@M_" + "MTKThermalManagerActivity", "Spinner1 OnItemSelectedListener.onNothingSelected()\n");
                    }
                });
        s1.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				{
					count++;
					Log.d("@M_" + "MTKThermalManagerActivity", "Spinner1 OnTouchListener.onTouch() cnt=" + count + "\n");
					mtc_file_list.clear();
  ...
  public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
    ...
    {
    case 0:
      Log.d("@M_" + "MTKThermalManagerActivity", "onItemClick() ThermalSensorActivity");
      ...
      break;
    case 1:
      Log.d("@M_" + "MTKThermalManagerActivity", "onItemClick() CoolersActivity");
  ...
  public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
    ...
    if (((CompoundButton) thermal_logger_switch).equals(buttonView))
    {
      if (isChecked)
      {
        if (isThermalLoggerEnabled())
        {
          Log.d("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() 1 logger already started");
        }
        else
        {
          // start logging
          // TODO: get execution duration.
          Log.d("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() start logging");
          ...
          Log.d("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() logging started");
        }
      }
      else
      {
        if (isThermalLoggerEnabled())
        {
          Log.d("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() stop logging");
          ...
          Log.d("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() disable storage logger");
          ...
          if(new File("/data").exists())
          {
            ...
            Log.d("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() test write to /data");
            ...
            {
              Log.e("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() append file exception!");
            }
          ...
          {
            Log.d("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() data does not exist!");
    ...
    {
      Log.e("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() buttonView not found!");
    }
  ...
  private void executeShellCommand(String shellCommand)
  {
    ...
    catch (IOException ex)
    {
      ...
      Log.e("@M_" + "MTKThermalManagerActivity", "execCommandLine() IO Exception: ");
      return;
    }
    finally
    {
      if (null != osw)
      {
        try
        {
          ...
          Log.d("@M_" + "MTKThermalManagerActivity", "IOE\n");
        }
      }
    }
    ...
    try
    {
      ...
      Log.d("@M_" + "MTKThermalManagerActivity", "Interrupted\n");
    }

    if (proc.exitValue() != 0)
    {
      //Xlog.e("MTKThermalManagerActivity", "execCommandLine() Err exit code: " + proc.exitValue() + " " + shellCommand);
      Log.e("@M_" + "MTKThermalManagerActivity", "execCommandLine() Err exit code: " + proc.exitValue());
    }
  }
  ...
  {
      Log.d("@M_" + "MTKThermalManagerActivity", "turnOffThermalLoggerAndDumpLog() stop logging");
      ...
      Log.d("@M_" + "MTKThermalManagerActivity", "turnOffThermalLoggerAndDumpLog() disable storage logger");
      ...
      {
        Log.d("@M_" + "MTKThermalManagerActivity", "onCheckedChanged() sdcard does not exist!");
        Toast.makeText(this, "No storage to dump thermal Log!\n Please use adb command: \n @adb pull /proc/driver/storage_logger_display storage_logger_dump  ", Toast.LENGTH_LONG).show();
      }
       */
  }
  ...
  private void writeFile(String filePath, String line)
  {
    ...
    if (a.exists())
    {
      try {
        ...
        Log.e("@M_" + "MTKThermalManagerActivity", "writeFile() Exception: " + filePath);
      }
    }
    else
    {
      Log.d("@M_" + "MTKThermalManagerActivity", "writeFile() File not exist: " + filePath);
      try {
        if (a.createNewFile())
        {
          Log.d("@M_" + "MTKThermalManagerActivity", "writeFile() File created: " + filePath);
          try {
            FileOutputStream fs = new FileOutputStream(a);
            DataOutputStream ds = new DataOutputStream(fs);
            ds.write(line.getBytes());
        ...
        {
          Log.d("@M_" + "MTKThermalManagerActivity", "writeFile() Create file fail: " + filePath);
        }
      }
      catch (IOException e)
      {
          Log.e("@M_" + "MTKThermalManagerActivity", "writeFile() creatFile Exception: " + filePath);
      }
    }
  }
  ...
  private boolean isThermalLoggerEnabled()
  {
      ...
      if (thermal_logger_config.exists())
      {
          ...
          {
            Log.e("@M_" + "MTKThermalManagerActivity", "isThermalLoggerEnabled() IOException");
          }
