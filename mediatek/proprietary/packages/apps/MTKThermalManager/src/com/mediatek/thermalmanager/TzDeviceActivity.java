...
public class TzDeviceActivity extends Activity implements OnItemClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra("tz_sysfs_path") != null)
        {
            ...
            Log.d("@M_" + "TzDeviceActivity", "sysfs_path: " + intent.getStringExtra("tz_sysfs_path"));
        }
        else
        {
            Toast.makeText(TzDeviceActivity.this, "File temperarily unavailable!", Toast.LENGTH_SHORT).show();
            Log.d("@M_" + "TzDeviceActivity", "sysfs_path: null!!!\n");
            return;
        }
        ...
        else
        {
            ...
            Log.d("@M_" + "TzDeviceActivity", "temp not exists\n");
        }
        ...
        else
        {
            ...
            Log.e("@M_" + "TzDeviceActivity", "mode not exists\n");
        }
