...
public class ThermalSensorActivity extends Activity implements OnItemClickListener{
    ...
    private class ThermalSensorsLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void results) {  
            ...
            Log.d("@M_" + "ThermalSensorActivity", "onPostExecute "+ items.size() + "\n");
            if (0 == items.size())
            {
        ...
        protected Void doInBackground(Void... params) {  
            ...
            Log.d("@M_" + "ThermalSensorActivity", "doInBackground\n");
                ...
                if( thermal_dev_file_list[i].getName().contains("thermal_zone"))
                {
                    ...
                    if (a.exists())
                    {
                        try {
                            ...
                            Log.d("@M_" + "ThermalSensorActivity", "IOE\n");
                        }
                    }
                    ...
                    Log.d("@M_" + "ThermalSensorActivity", "doInBackground "+ toshow + "\n");
                    items.add(toshow);
                }
            }
            return null;
