...
enum
{
	...
	AWB_TAG_SHADE_SUBWIN_PROP_EN_F,
    ...
    AWB_TAG_VERTEX_XR_F,
    AWB_TAG_VERTEX_YR_F,
    AWB_TAG_SHADE_LV_L_F,
    AWB_TAG_SHADE_LV_H_F,
	...
	AWB_TAG_SHADE_SUBWIN_PROP_EN_CWF,
    ...
    AWB_TAG_VERTEX_XR_CWF,
    AWB_TAG_VERTEX_YR_CWF,
    AWB_TAG_SHADE_LV_L_CWF,
    AWB_TAG_SHADE_LV_H_CWF,
    ...
    AWB_TAG_SUNSET_COUNT_D,
    AWB_TAG_SUNSET_RATIO_D,
    AWB_TAG_SUNSET_EN_D,
    AWB_TAG_SUNSET_LV_L_D,
    AWB_TAG_SUNSET_LV_H_D,   
...
#define AWB_DEBUG_TAG_VERSION (AWB_TAG_95_K2_F_CWF_SMOOTH)
