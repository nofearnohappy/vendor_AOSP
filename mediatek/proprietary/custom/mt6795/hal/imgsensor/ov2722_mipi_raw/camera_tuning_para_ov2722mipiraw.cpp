...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        512,      // i4B_MIN
                { // i4P00[9]
            5116082, -2206538, -349543, -494901, 3295990, -241089, 153392, -1391139, 3797747
                },
                { // i4P10[9]
            0,  0, 0, 0,  0,  0, 0,   0, 0              
                },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        // rDevicesInfo
        {
            ...
            29723,     // u4Video1ExpUnit
            30,     // u4Video1MaxFrameRate
            1024,   // u4Video12PreRatio, 1024 base = 1x
            29723,     // u4Video2ExpUnit
            30,     // u4Video2MaxFrameRate
            1024,   // u4Video22PreRatio, 1024 base = 1x
            29723,     // u4Custom1ExpUnit
            30,     // u4Custom1MaxFrameRate
            1024,   // u4Custom12PreRatio, 1024 base = 1x
            29723,     // u4Custom2ExpUnit
            30,     // u4Custom2MaxFrameRate
            1024,   // u4Custom22PreRatio, 1024 base = 1x
            29723,     // u4Custom3ExpUnit
            30,     // u4Custom3MaxFrameRate
            1024,   // u4Custom32PreRatio, 1024 base = 1x
            29723,     // u4Custom4ExpUnit
            30,     // u4Custom4MaxFrameRate
            1024,   // u4Custom42PreRatio, 1024 base = 1x
            29723,     // u4Custom5ExpUnit
		...
		-183,	// i4SlopeNumerator		
			...
			-315	// PDayLowerBound				            
                        ...
                        // Cloudy daylight
                        {
			320,	// PCloudyRightBound				        
			145,	// PCloudyLeftBound				            
			-176,	// PCloudyUpperBound				        
			-315	// PCloudyLowerBound				        
                        },
                        // Shade
                        {
			420,	// PShadeRightBound				          
			145,	// PShadeLeftBound				          
			-176,	// PShadeUpperBound				          
			-315	// PShadeLowerBound				          
                        },
                        // Twilight
                        {
			8,	// PTwiRightBound				            
                ...
                // Algorithm Tuning Paramter
                {
                    ...
                    // AWB feature detection
                    {
                        // Sunset Prop
                        {
                            ...
                            140,        // i4LVThr
                            {
                                84,   // i4Sunset_BoundXr_Thr
                                -110     // i4Sunset_BoundYr_Thr
                            },
                            10,         // i4SunsetCountThr
			...
			6500     // CCT4				                      
		            ...
		            {
			-550,	// RotatedXCoordinate0				      
			-415,	// RotatedXCoordinate1				      
			-272,	// RotatedXCoordinate2				      
