...
public class SubInfoUtils {
    ...
    public static SubscriptionInfo getSubInfoUsingSubId(int subId, Context context) {
    ...
    public static String getDisplaynameUsingSubId(int subId, Context context) {
        if (!checkSubscriber(subId)) {
            return null;
        }
        SubscriptionInfo subscriptionInfo = getSubInfoUsingSubId(subId, context);
