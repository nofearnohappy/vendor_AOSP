 ...
 */
public class ProfileXcapException extends Exception {
    ...
    public static final int HTTP_CONNNECT_EXCEPTION = 15;
     ...
     */
    public ProfileXcapException(int httpErrorCode) {
     ...
     */
    public ProfileXcapException(IOException httpException) {
