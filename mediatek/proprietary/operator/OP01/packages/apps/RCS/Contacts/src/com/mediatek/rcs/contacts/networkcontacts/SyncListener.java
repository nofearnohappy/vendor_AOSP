...
/**
 * State listener of Sync Engine.
 * @author MTK80963
 *
 */
public interface SyncListener {
    /**
     * Constants of the return code:
     * <= SYNC_STATE_SUCCESS : sync complete with error or no error.
     */
    public static final int SYNC_STATE_SUCCESS = 0;

    /**
     * @see #SYNC_STATE_SUCCESS
     */
    ...
    /**
     * Listener for sync result. Considering about the resource conflict.
     * for this function may be called from a different thread.
