...
public class AsyncDialog {
     ...
     *
     * @param backgroundTask the work to be done in the background wrapped in a
     *            Runnable
     * @param postExecuteTask an optional runnable to run on the UI thread when
     *            the background runnable is finished
