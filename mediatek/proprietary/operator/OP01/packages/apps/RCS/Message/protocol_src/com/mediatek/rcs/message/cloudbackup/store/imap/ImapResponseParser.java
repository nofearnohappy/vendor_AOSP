...
import com.mediatek.rcs.message.cloudbackup.utils.PeekableInputStream;
...
public class ImapResponseParser {
    ...
    private static final String LOG_TAG = "RcsBR/ImapResponseParser";
    ...
    public ImapResponse readResponse() throws IOException, MessagingException {
        ...
        if (response.is(0, ImapConstants.BYE)) {
            Log.w(LOG_TAG, ByeException.MESSAGE);
            response.destroy();
    ...
    private void onParseError(Exception e) {
        ...
        Log.w(LOG_TAG, "Exception detected: " + e.getMessage());
