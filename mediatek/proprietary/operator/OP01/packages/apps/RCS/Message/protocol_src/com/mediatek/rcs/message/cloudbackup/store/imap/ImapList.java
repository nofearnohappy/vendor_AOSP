...
public class ImapList extends ImapElement {
     ...
     * @param s
     *            .
     * @return true if the element at {@code index} exists, is string, and
     *         equals to {@code s}.
     */
     ...
     * @param prefixMatch .
     * @return an {@link ImapList} keyed by {@code key}.
     *         {@link ImapList#EMPTY} if not found.
     */
     ...
     *         {@link ImapString#EMPTY} if not found.
     */
     ...
     * @param prefixMatch .
     * @return
     * an {@link ImapString} keyed by {@code key}.
     * {@link ImapString#EMPTY} if not found.
     */
