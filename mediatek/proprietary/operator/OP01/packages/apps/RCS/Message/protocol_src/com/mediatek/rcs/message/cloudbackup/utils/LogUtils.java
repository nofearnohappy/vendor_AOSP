...
public class LogUtils {
    ...
    public static final String TAG = "RcsBR";
    ...
    /**
     * @return true if the build configuration prevents debug logging.
     */
    ...
    public static int d(String tag, Throwable tr, String format, Object... args) {
        if (isLoggable(tag, DEBUG)) {
            ...
            /**
             * M: If the given log string contain some special string, such as
             * "%s", JE will happened, it is not a best solution just catch it,
             * but current code contains too many not format logs. Make sure
             * email not crash, and throws a error log. @{
             */
            /** @} */
        }
        return 0;
    ...
    public static int wtf(String tag, String format, Object... args) {
        ...
        /**
         * M: If the given log string contain some special string, such as "%s",
         * JE will happened, it is not a best solution just catch it, but
         * current code contains too many not format logs. Make sure email not
         * crash, and throws a error log. @{
         */
        /** @} */
    }
     ...
     * @return .
     */
    public static int wtf(String tag, Throwable tr, String format,
            Object... args) {
    ...
    /**
     * M: some feature log, tag always from TAG. e.g: I/Email( 9178):
     * [SearchMail]buildMessageListSelection,.
     * @param featureName .
     * @param format .
     * @param args .
     * @return .
