...
public class ActionBarAdapter  {
    ...
    public void initialize(Bundle savedState) {
        if (savedState == null) {
            ...
            Log.d("@M_" + "TaskManager" , "init tab saved null " + mCurrentTab);
        } else {
            mCurrentTab = TabState.fromInt(savedState.getInt(EXTRA_KEY_SELECTED_TAB));
            Log.d("@M_" + "TaskManager" , "init tab saved  " + mCurrentTab);
        }
        update();
    }
    ...
    private void updateDisplayOptions() {
        ...
        if (current != newFlags) {
            ...
            Log.d("@M_" + "TaskManager" , "set action bar flag " + newFlags);
    ...
    private void saveLastTabPreference(TabState tab) {
        Log.d("@M_" + "TaskManager" , "saveLastTabPreference " + tab);
