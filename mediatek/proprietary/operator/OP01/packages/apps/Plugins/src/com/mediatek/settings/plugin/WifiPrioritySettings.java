...
public class WifiPrioritySettings  extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    public void initPage() {
        if (mWifiManager == null) {
            Log.e("@M_" + TAG, "Fail to get Wifi Manager service");
            return;
        }
...
//                priorityValues[i]=String.valueOf(configuredApCount-i);
            ...
            for (int i = 0; i < configuredApCount; i++) {
                Log.e("@M_" + TAG, "Before sorting: priority array=" + mConfigs.get(i).priority);
            }
            ...
            for (int i = 0; i < configuredApCount; i++) {
                Log.e("@M_" + TAG, "After sorting: order array=" + mPriorityOrder[i]);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference instanceof ListPreference) {
            ...
            try {
                ...
                Log.e("@M_" + TAG, "Error happens when modify priority manually");
                e.printStackTrace();
            }
            Log.e("@M_" + TAG, "Priority old value=" + oldOrder + ", new value=" + newOrder);
