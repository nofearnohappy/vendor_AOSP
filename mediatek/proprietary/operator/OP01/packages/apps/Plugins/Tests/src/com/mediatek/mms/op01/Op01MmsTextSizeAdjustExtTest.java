...
//        mContext = this.getInstrumentation().getContext();
    ...
    public void setTextSize(float size) {
        Log.v("@M_" + TAG, "setTextSize: size = " + size);
        mTextSize = size;
    }


    public void test01_initAndRefresh() {
        Log.v("@M_" + TAG, "test01_initAndRefresh...");
        if (mPlugin != null) {
    ...
    public void test03_ScaleLarge()throws Exception {
        Log.v("@M_" + TAG, "test03_ScaleLarge...");
        if (mPlugin != null) {
            mTextSize = 18;
            Op01MmsUtils.setTextSize(mContext, mTextSize);
            mPlugin.init(this, null);
            ...
            Log.v("@M_" + TAG, "test03: beginSize = " + beginSize);
            ...
            Log.v("@M_" + TAG, "end text size = " + endSize);
