...
class MmsTestMenu implements Menu {
    ...
    public MenuItem add(int groupId, int itemId, int order, CharSequence title) {
        Log.d("@M_" + TAG, "menu add," + itemId + title);
    ...
    public MenuItem findItem(int id) {
        Log.d("@M_" + TAG, "findItem," + id);
        for (MmsTestMenuItem item : mItems) {
            Log.d("@M_" + TAG, "item," + item.getItemId());
    ...
    public MenuItem getItem(int index) {
        Log.d("@M_" + TAG, "getItem," + index);
        Log.d("@M_" + TAG, "item num=" + mCount);
        //MenuItem item = mItems.get(index);
        MenuItem item = mItems[index];
        Log.d("@M_" + TAG, "item id=" + item.getItemId());

        MenuItem test = mItems[0]; //mItems.get(0);
        Log.d("@M_" + TAG, "0 id=" + test.getItemId());
        test = mItems[0]; //Items.get(1);
        Log.d("@M_" + TAG, "1 id=" + test.getItemId());
        return item;
    }
...
class MmsTestMenuItem implements MenuItem {
    ...
    public MmsTestMenuItem(int id) {
        Log.d("@M_" + TAG, "MmsTestMenuItem, " + id);
        mId = id;
    }
