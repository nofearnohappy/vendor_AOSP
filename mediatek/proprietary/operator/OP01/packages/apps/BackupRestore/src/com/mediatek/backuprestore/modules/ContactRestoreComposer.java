...
public class ContactRestoreComposer extends Composer {
    ...
    public boolean implementComposeOneEntity() {
        ...
        if (mIndex == 1) {
            if (mInputStream != null) {
                ...
                MyLogger.logD(CLASS_TAG, "implementComposeOneEntity :readOneVCard "
    ...
    private int getContactCount() {
        int count = 0;
        try {
            MyLogger.logD(CLASS_TAG, "begin getContactCount:" + System.currentTimeMillis());
            String fileName = mParentFolderPath + File.separator + ModulePath.FOLDER_CONTACT
                    + File.separator + ModulePath.NAME_CONTACT;
        ...
        MyLogger.logD(CLASS_TAG, "end getContactCount:" + System.currentTimeMillis());
        return count;
    }
    ...
    private class RestoreVCardEntryCommitter extends VCardEntryCommitter {
        ...
        public void onEntryCreated(final VCardEntry vcardEntry) {
            ...
            MyLogger.logD(CLASS_TAG, "onEntryCreated:" + System.currentTimeMillis());
