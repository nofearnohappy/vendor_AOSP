...
public class AppRestoreComposer extends Composer {
        ...
        try {
            ...
            if (!isCtsLoad) {
                ...
                MyLogger.logD(CLASS_TAG,
                        "this is CTS project,can't start native service to restore app data");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onStart() {
        ...
        intent.setClassName("com.mediatek.backuprestore.modules",
                "com.mediatek.backuprestore.modules.AidlService");
        try {
