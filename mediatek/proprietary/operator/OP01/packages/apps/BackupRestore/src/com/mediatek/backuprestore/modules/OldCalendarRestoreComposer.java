...
public class OldCalendarRestoreComposer extends Composer {
    ...
    public boolean init() {
        ...
        MyLogger.logD(CLASS_TAG,
                CALENDARTAG + "init():" + result + ",count:" + mFileNameList.size());
        return result;
    }
    ...
    public boolean implementComposeOneEntity() {
        ...
        MyLogger.logD(CLASS_TAG, CALENDARTAG + "implementComposeOneEntity():" + mIdx + ",result:"
                + result);
        return result;
    }
    ...
    private boolean deleteAllCalendarEvents() {
        ...
        MyLogger.logD(CLASS_TAG, CALENDARTAG + "deleteAllCalendarEvents()result:" + result + ", "
