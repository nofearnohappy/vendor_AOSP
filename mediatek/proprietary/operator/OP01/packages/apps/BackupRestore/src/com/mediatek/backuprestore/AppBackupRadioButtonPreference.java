...
public class AppBackupRadioButtonPreference extends Preference {
    ...
    /*
     * public void showCheckbox(boolean bshow) { MyLogger.logD(CLASS_TAG,
     * "showCheckbox: " + bshow); mVisibility = bshow; if (mCheckBox == null) {
     * return; } if (bshow) { mCheckBox.setVisibility(View.VISIBLE); } else {
