    ...
    public boolean implementComposeOneEntity() {
        ...
        if (content != null) {
            ...
            final VCardEntryConstructor constructor = new VCardEntryConstructor(
                    VCardConfig.VCARD_TYPE_V21_GENERIC, account, estimatedCharset);
            ...
            result = readOneVCard(is, VCardConfig.VCARD_TYPE_V21_GENERIC, constructor,
        ...
        MyLogger.logD(CLASS_TAG, "mZipFileName:" + mZipFileName + ",contactFileName:"
                + contactFileName + ",result:" + result);
