...
public class NoteBookXmlComposer {
    private NoteBookXmlSerializer mSerializer = null;
    ...
    public boolean startCompose(File path) throws IOException {
        ...
        mSerializer = new NoteBookXmlSerializer();
        if (mSerializer == null) {
    ...
    public boolean addOneNotebookRecord(NoteBookXmlInfo record) throws IOException {
        boolean result = false;
        try {
