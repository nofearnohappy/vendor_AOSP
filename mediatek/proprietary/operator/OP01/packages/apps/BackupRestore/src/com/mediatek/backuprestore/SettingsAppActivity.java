...
public class SettingsAppActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            Log.d(CLASS_TAG, "~~ onCreate ~ and savedInstanceState = null mSettingData = "
                    + mSettingData);
        }
    ...
    private List<SettingData> initData(Bundle savedInstanceState) {
        SharedPreferences sharedPreferences = getSharedPreferences(Constants.SETTINGINFO,
        ...
        SettingData mAppAndData = new SettingData(getResources().getString(
                R.string.app_data), getResources().getString(R.string.appdata_summary),
                checked, Constants.APP_AND_DATA);
        SettingData mAppData = new SettingData(getResources().getString(R.string.only_app), null,
                !checked, Constants.ONLY_APP);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference != null && preference instanceof AppBackupRadioButtonPreference) {
            ...
            Log.d(CLASS_TAG, "~onPreferenceTreeClick~  ~title = " + mTitle + ", checked = "
                    + mChecked);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        Log.d(CLASS_TAG, "~~ onSaveInstanceState ~title = " + mTitle + ", checked = " + mChecked
                + ", mSettingData = " + mSettingData);
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            ...
            mSettingData.putString(Constants.DATE, mTitle);
            Log.d(CLASS_TAG,
                    "~~ onKeyDown  ~ mSettingData = " + mSettingData.getString(Constants.DATE));
            Intent data = new Intent();
            data.putExtras(mSettingData);
            setResult(RESULT_OK, data);
        }
