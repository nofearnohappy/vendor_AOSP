...
public class OldSmsRestoreComposer extends Composer {
    ...
    public boolean implementComposeOneEntity() {
        ...
        if (storePdu != null) {
            SmsXmlInfo record = mRecord.get(pduFileName.subSequence(
                    pduFileName.lastIndexOf(File.separator) + 1, pduFileName.length()));
            if (record == null) {
            ...
            if (values == null) {
                ...
                ContentProviderOperation.Builder builder = ContentProviderOperation
                        .newInsert(SMSURI[Integer.parseInt(record.getMsgBox()) - 1]);
