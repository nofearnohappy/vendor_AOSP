...
public class NoteBookBackupComposer extends Composer {
    ...
    /*
     * private void writeToFile(String inBuf) throws IOException { try { if
     * (outStream == null) { outStream = new FileOutputStream(mParentFolderPath
     * + File.separator + ModulePath.FOLDER_NOTEBOOK + File.separator +
