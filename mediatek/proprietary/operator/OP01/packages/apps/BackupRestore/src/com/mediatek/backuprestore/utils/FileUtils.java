...
public class FileUtils {
    ...
    public static boolean isMtkOldSmsData(String path) {
        ...
        try {
            ...
            mFileNameList = (ArrayList<String>) BackupZip.getFileList(path, true, true,
                    "sms/sms[0-9]+");
            mXmlList = (ArrayList<String>) BackupZip.getFileList(path, true, true,
                    "sms/msg_box.xml");
            ...
            MyLogger.logD(CLASS_TAG, "isMtkOldSmsData() mFileNameList.size:" + mFileNameList.size()
                    + ", content:" + content);
        } catch (IOException e) {
