...
public class OldMusicRestoreComposer extends Composer {
    ...
    public final boolean init() {
        ...
        try {
            ...
            String temp = SDCardUtils.getStoragePath(mContext);
            if (temp == null) {
                return result;
            }
    ...
    public final boolean implementComposeOneEntity() {
        ...
        mDestFileName = mDestPath
                + musicName.subSequence(musicName.lastIndexOf(File.separator), musicName.length())
                        .toString();
        if (mImport) {
            ...
            if (file.isFile()) {
                try {
                    ...
                    MyLogger.logD(CLASS_TAG,
                            MUSICTAG + "deleteFolder():" + count + ":" + file.getAbsolutePath());
                    file.delete();
                } catch (Exception e) {
