...
public class OldAppRestoreComposer extends Composer {
    ...
    public boolean implementComposeOneEntity() {
        ...
        String destFileName = temp.substring(0, index + 1)
                + ".backup"
                + "/"
                + "temp"
                + apkFileName.subSequence(apkFileName.lastIndexOf("/"), apkFileName.length())
                        .toString();
        ...
        try {
            ...
            if (apkFile != null && apkFile.exists()) {
                ...
                pkgManager.installPackage(Uri.fromFile(apkFile), obs,
