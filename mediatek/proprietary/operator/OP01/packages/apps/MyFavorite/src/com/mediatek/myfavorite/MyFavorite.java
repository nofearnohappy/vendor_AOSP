...
public class MyFavorite extends Activity implements OnItemClickListener {
    ...
    private void launchGallery(Uri uri, String mimeType) {
        try {
            if (null == mimeType) {
                ...
                Log.i("@M_" + TAG, "launchGallery(): photo path is " + photoPath);
                if (photoPath == null) {
                    photoPath = getDefaultPhotoPath();
                    Log.i("@M_" + TAG, "launchGallery(): default photo path is " + photoPath);
                }
    ...
    private String getDefaultPhotoPath() {
        ...
        Log.i("@M_" + TAG, "getDefaultPhotoPath(): defaultStoragePath=" + defaultStoragePath);
