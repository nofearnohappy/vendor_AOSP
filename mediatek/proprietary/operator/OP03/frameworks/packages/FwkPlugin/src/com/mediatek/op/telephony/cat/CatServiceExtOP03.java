...
@PluginImpl(interfaceName = "com.mediatek.common.telephony.cat.ICatServiceExt")
public class CatServiceExtOP03 extends CatServiceExt {

    public void updateMenuTitleFromEf(String appName) {
        String newAppName = appName;
        CatLog.d(this, "updateMenuTitleFromEf, appName: " + appName);
    ...
    private String getMenuTitleFromEf() {
        ...
        IccRecords ic = null;
        if (mCatService != null) {
            ic = ((CatService) mCatService).getIccRecords();
        }
        if (ic != null) {
            title = ic.getMenuTitleFromEf();
        }
        CatLog.d("[OP]", "mCatService: " + ((mCatService != null) ? 1 : 0) + ", ic: " +
                ((ic != null) ? 1 : 0) + ", Title: " + ((title != null) ? title : "title is null"));
        return title;
    }

    public static CatServiceExt getInstance() {
        return mInstance;
    }
    ...
    */
    public boolean unInstallIfNoSim() {
        CatLog.d(this, "unInstallIfNoSim() return true");
        return true;
    }
}
