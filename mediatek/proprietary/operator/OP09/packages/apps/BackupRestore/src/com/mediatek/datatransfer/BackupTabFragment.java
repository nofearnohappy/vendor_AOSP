...
public class BackupTabFragment extends ListFragment {
    ...
    //temp private ITelephonyEx mTelephonyEx;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // mTelephonyEx = ITelephonyEx.Stub.asInterface(ServiceManager.getService
    ...
    private boolean isSIMLocked(int simId) {
        ...
        return false; //temp
        // statue == com.android.internal.telephony.PhoneConstants.SIM_INDICATOR_LOCKED;
    }
    ...
    private class ConfigListItemAdapter extends BaseAdapter {
        ...
        public View getView(final int position, final View convertView, final ViewGroup parent) {
            ...
            if (position != 0) {
                ...
                if (imgView != null) {
                    int status = getSimIndicator(mSimInfoList.get(position - 1).slotId);
                ...
                if (viewSim != null) {
                    ...
                    int res = Utils.getSimColorResource(mSimInfoList.get(position - 1).color);
...
//            } else {
//                //temp return PhoneConstants.SIM_INDICATOR_UNKNOWN;
//            }
//        } catch (RemoteException e) {
//            Log.d(CLASS_TAG, "RemoteException");
//            //temp  return temp PhoneConstants.SIM_INDICATOR_UNKNOWN;
