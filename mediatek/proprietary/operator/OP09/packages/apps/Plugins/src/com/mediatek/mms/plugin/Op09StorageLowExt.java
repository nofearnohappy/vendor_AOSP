 ...
 * M: Op09StorageLowExt.
 */
public class Op09StorageLowExt {
    private static final String TAG = "Mms/OP09StorageLowExt";
    private static final int STORAGE_LOW_NOTIFICATION_ID = 240;
    private Resources mResources = null;
    private static Op09StorageLowExt sOp09StorageLowExt;

    public static Op09StorageLowExt getIntance(Context context) {
        if (sOp09StorageLowExt == null) {
            sOp09StorageLowExt = new Op09StorageLowExt(context);
        }
        return sOp09StorageLowExt;
    }
    ...
    public String getNotificationTitle() {
        Log.d("@M_" + TAG, "OP09StorageLowExt.getNotificationTitle()");
        return mResources.getString(R.string.storage_low_title);
    }


    public String getNotificationBody() {
        Log.d("@M_" + TAG, "OP09StorageLowExt.getNotificationBody()");
    ...
    public void showNotification(NotificationManager notificationMgr, Notification notification) {
        Log.d("@M_" + TAG, "OP09StorageLowExt.showNotification()");
    ...
    public void cancelNotification(NotificationManager notificationMgr) {
        Log.d("@M_" + TAG, "OP09StorageLowExt.cancelNotification()");
