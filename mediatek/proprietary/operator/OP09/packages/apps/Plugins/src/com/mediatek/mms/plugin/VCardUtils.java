...
public class VCardUtils {
    ...
    public static List<VCardEntry> parserVCardFile(Context context, Uri dataUri,
                                    VCardEntryConstructor interpreter,
            int parseFlag) {
        ...
        try {
            ...
            Log.e(TAG, "parserVCardFile(): VCardException.", e);
            toastErrorHappened(context, R.string.file_attachment_import_vcard);
            return null;
        } catch (IOException e) {
            Log.e(TAG, "parserVCardFile(): IOException.", e);
            toastErrorHappened(context, R.string.file_attachment_import_vcard);
            return null;
        } finally {
            try {
                ...
                Log.e(TAG, "parserVCardFile(): IOException when close.", e);
            }
        }
    ...
    public static String getVCardFirstContactName(Context context, Uri dataUri) {
        List<VCardEntry> vCardEntryList = parserVCardFile(context, dataUri,
                new VCardEntryConstructor(), PARSE_ONE);
    ...
    public static int getVCardContactsCount(Context context, Uri dataUri) {
        Log.e(TAG, "getVCardContactsCount(): dataUri = " + dataUri);
        ...
        try {
            ...
            Log.e(TAG, "getVCardContactsCount(): IOException.", e);
            return 0;
        } finally {
            try {
                if (inputStream != null) {
                ...
                Log.e(TAG, "getVCardContactsCount(): IOException when close.", e);
            }
        }
    }
    ...
    public static class MyToStringIterator implements EntryElementIterator {
        ...
        public boolean onElement(EntryElement elem) {
            if (elem.isEmpty()) {
                Log.d(TAG, "MyToStringIterator.onElement(): elem is empty.");
                return false;
            }
...
//                AndroidCustomData androidCustomData = (AndroidCustomData) elem;
    ...
    public static long[] getContactsIds(String vCardContactsIds) {
        ...
        if (vCardContactsIds != null && !vCardContactsIds.equals("")) {
            ...
            Log.e(TAG, "getContactIds(): vCardConIds.length" + vCardConIds.length);
