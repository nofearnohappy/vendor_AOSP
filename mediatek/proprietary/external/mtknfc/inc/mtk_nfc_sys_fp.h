...
typedef UINT16 (*fpmtk_nfc_sys_ioctl_set_param)(MtkNfcDriver_ParamID_et ParamId,UINT16 SetValue);
typedef UINT16 (*fpmtk_nfc_sys_ioctl_get_param)(MtkNfcDriver_ParamID_et ParamId);
...
typedef struct MTK_NFC_SYS_FUNCTION_POINT
{
   ...
   fpmtk_nfc_sys_ioctl_set_param       sys_ioctl_set_param;
   fpmtk_nfc_sys_ioctl_get_param       sys_ioctl_get_param;
