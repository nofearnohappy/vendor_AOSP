...
int vcsEnableRecognition();
    /*
       - enable the voice contact search recognition;
         without invoking this function, vcsRecognize() will never return a recognized result
         symmetry function of vcsDisableRecognition()
    */


int vcsDisableRecognition();
    /*
       - disable the voice contact search recognition;
         after invoking this function, vcsRecognize() will return no recognition result
         symmetry function of vcsEnableRecognition()
    */
