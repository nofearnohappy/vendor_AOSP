...
#-----------------------------------------------------------
sinclude $(TOP)/$(MTK_MTKCAM_PLATFORM)/hardware/mtkcam/mtkcam.mk
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/include/mmsdk
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mmsdk/include
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/include/mmsdk
