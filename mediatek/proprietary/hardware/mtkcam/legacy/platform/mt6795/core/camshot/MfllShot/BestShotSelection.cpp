...
int bss(MF_BSS_PARAM_STRUCT &MF_BSS_PARAM, BSS_INPUT_DATA *in, BSS_OUTPUT_DATA *out)
{
    ...
    if( MF_BSS_PARAM.MF_BSS_ON )
    {
        ...
        {
            //check legal region
            u4ROI_x = MF_BSS_PARAM.MF_BSS_ROI_X0 + gmv[1].x;
            if(u4ROI_x<0)
                u4ROI_x = 0;
            if ((u4ROI_x+MF_BSS_PARAM.MF_BSS_ROI_WIDTH)>=inMEWidth)
                u4ROI_x = inMEWidth - MF_BSS_PARAM.MF_BSS_ROI_WIDTH -1;

            u4ROI_y = MF_BSS_PARAM.MF_BSS_ROI_Y0 + gmv[1].y;
            if(u4ROI_y<0)
                u4ROI_y = 0;
            if ((u4ROI_y+MF_BSS_PARAM.MF_BSS_ROI_HEIGHT)>=inMEHeight)
                u4ROI_y = inMEHeight - MF_BSS_PARAM.MF_BSS_ROI_HEIGHT -1;
            sharp_score[1] = BSS_ALG(Proc1QR1Img, inMEWidth, inMEHeight,
                                 MF_BSS_PARAM.MF_BSS_ROI_WIDTH, MF_BSS_PARAM.MF_BSS_ROI_HEIGHT,
                                 u4ROI_x, u4ROI_y,
                                 MF_BSS_PARAM.MF_BSS_SCALE_FACTOR, MF_BSS_PARAM.MF_BSS_CLIP_TH0, MF_BSS_PARAM.MF_BSS_CLIP_TH1, iClip_TH1_Squared);
            ...
            //check legal region
            u4ROI_x = MF_BSS_PARAM.MF_BSS_ROI_X0 + gmv[2].x;
            if(u4ROI_x<0)
                u4ROI_x = 0;
            if ((u4ROI_x+MF_BSS_PARAM.MF_BSS_ROI_WIDTH)>=inMEWidth)
                u4ROI_x = inMEWidth - MF_BSS_PARAM.MF_BSS_ROI_WIDTH -1;

            u4ROI_y = MF_BSS_PARAM.MF_BSS_ROI_Y0 + gmv[2].y;
            if(u4ROI_y<0)
                u4ROI_y = 0;
            if ((u4ROI_y+MF_BSS_PARAM.MF_BSS_ROI_HEIGHT)>=inMEHeight)
                u4ROI_y = inMEHeight - MF_BSS_PARAM.MF_BSS_ROI_HEIGHT -1;
            ...
            //check legal region
            u4ROI_x = MF_BSS_PARAM.MF_BSS_ROI_X0 + gmv[3].x;
            if(u4ROI_x<0)
                u4ROI_x = 0;
            if ((u4ROI_x+MF_BSS_PARAM.MF_BSS_ROI_WIDTH)>=inMEWidth)
                u4ROI_x = inMEWidth - MF_BSS_PARAM.MF_BSS_ROI_WIDTH -1;

            u4ROI_y = MF_BSS_PARAM.MF_BSS_ROI_Y0 + gmv[3].y;
            if(u4ROI_y<0)
                u4ROI_y = 0;
            if ((u4ROI_y+MF_BSS_PARAM.MF_BSS_ROI_HEIGHT)>=inMEHeight)
                u4ROI_y = inMEHeight - MF_BSS_PARAM.MF_BSS_ROI_HEIGHT -1;
