...
apply(EIspProfile_T eIspProfile, dip_x_reg_t* pReg)
{
    ...
    if (!fgOnOff) { // Reset to unit matrix
        reinterpret_cast<ISP_CAM_G2G_CNV_1_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_1))->G2G_CNV_00 = 512;
        reinterpret_cast<ISP_CAM_G2G_CNV_1_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_1))->G2G_CNV_01 = 0;
        reinterpret_cast<ISP_CAM_G2G_CNV_2_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_2))->G2G_CNV_02 = 0;
        reinterpret_cast<ISP_CAM_G2G_CNV_3_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_3))->G2G_CNV_10 = 0;
        reinterpret_cast<ISP_CAM_G2G_CNV_3_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_3))->G2G_CNV_11 = 512;
        reinterpret_cast<ISP_CAM_G2G_CNV_4_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_4))->G2G_CNV_12 = 0;
        reinterpret_cast<ISP_CAM_G2G_CNV_5_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_5))->G2G_CNV_20 = 0;
        reinterpret_cast<ISP_CAM_G2G_CNV_5_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_5))->G2G_CNV_21 = 0;
        reinterpret_cast<ISP_CAM_G2G_CNV_6_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CNV_6))->G2G_CNV_22 = 512;
    }
    ...
    // CAM_G2G_CTRL
    reinterpret_cast<ISP_CAM_G2G_CTRL_T*>(REG_INFO_VALUE_PTR(DIP_X_G2G_CTRL))->G2G_ACC = 9; // Q1.3.9
