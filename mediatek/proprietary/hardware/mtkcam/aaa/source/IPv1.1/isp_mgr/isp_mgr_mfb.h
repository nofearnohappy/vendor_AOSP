...
protected:
        ...
        , m_u4StartAddr(REG_ADDR_P2(DIP_X_MFB_LL_CON2))
    {
        ...
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_LL_CON2); // 0x0968
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_LL_CON3); // 0x096C
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_LL_CON4); // 0x0970
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_LL_CON5); // 0x0974
        INIT_REG_INFO_ADDR_P2(DIP_X_MFB_LL_CON6); // 0x0978
        #endif
    }
