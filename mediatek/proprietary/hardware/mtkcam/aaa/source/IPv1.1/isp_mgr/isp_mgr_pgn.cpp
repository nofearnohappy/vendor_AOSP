...
setIspPregain()
{
    ...
    // CAM_PGN_GAIN_1
    reinterpret_cast<ISP_CAM_PGN_GAIN_1_T*>(REG_INFO_VALUE_PTR(DIP_X_PGN_GAIN_1))->PGN_GAIN_B = m_rIspPregain.i4B;
    reinterpret_cast<ISP_CAM_PGN_GAIN_1_T*>(REG_INFO_VALUE_PTR(DIP_X_PGN_GAIN_1))->PGN_GAIN_GB = m_rIspPregain.i4G;

    // CAM_PGN_GAIN_2
    reinterpret_cast<ISP_CAM_PGN_GAIN_2_T*>(REG_INFO_VALUE_PTR(DIP_X_PGN_GAIN_2))->PGN_GAIN_GR = m_rIspPregain.i4G;
    reinterpret_cast<ISP_CAM_PGN_GAIN_2_T*>(REG_INFO_VALUE_PTR(DIP_X_PGN_GAIN_2))->PGN_GAIN_R = m_rIspPregain.i4R;

    // CAM_PGN_OFST_1
    MUINT32 OFFS = (m_i4IspFlareOffset >= 0) ? static_cast<MUINT32>(m_i4IspFlareOffset) : static_cast<MUINT32>(4096 + m_i4IspFlareOffset);
    reinterpret_cast<ISP_CAM_PGN_OFST_1_T*>(REG_INFO_VALUE_PTR(DIP_X_PGN_OFST_1))->PGN_OFST_B = OFFS;
    reinterpret_cast<ISP_CAM_PGN_OFST_1_T*>(REG_INFO_VALUE_PTR(DIP_X_PGN_OFST_1))->PGN_OFST_GB = OFFS;

    // CAM_PGN_OFST_2
    reinterpret_cast<ISP_CAM_PGN_OFST_2_T*>(REG_INFO_VALUE_PTR(DIP_X_PGN_OFST_2))->PGN_OFST_GR = OFFS;
    reinterpret_cast<ISP_CAM_PGN_OFST_2_T*>(REG_INFO_VALUE_PTR(DIP_X_PGN_OFST_2))->PGN_OFST_R = OFFS;
