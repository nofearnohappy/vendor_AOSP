...
protected:
        ...
        , m_u4StartAddr(REG_ADDR_P1(CAM_BNR_BPC_CON))
    {
        ...
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_CON);        // CAM+0x0800
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TH1);        // CAM+0x0804
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TH2);        // CAM+0x0808
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TH3);        // CAM+0x080C
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TH4);        // CAM+0x0810
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_DTC);        // CAM+0x0814
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_COR);        // CAM+0x0818
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TBLI1);      // CAM+0x081C
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TBLI2);      // CAM+0x0820
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TH1_C);      // CAM+0x0824
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TH2_C);      // CAM+0x0828
        INIT_REG_INFO_ADDR_P1(CAM_BNR_BPC_TH3_C);      // CAM+0x082C
        INIT_REG_INFO_ADDR_P1(CAM_BNR_NR1_CON);        // CAM+0x0850
        INIT_REG_INFO_ADDR_P1(CAM_BNR_NR1_CT_CON);     // CAM+0x0854
    }
