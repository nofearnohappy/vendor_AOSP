...
apply(EIspProfile_T eIspProfile, dip_x_reg_t* pReg)
{
    ...
    // PCA_LUT_360
    reinterpret_cast<ISP_CAM_PCA_CON1_T*>(REG_INFO_VALUE_PTR(DIP_X_PCA_CON1))->PCA_LUT_360 = (m_ePCAMode == EPCAMode_180BIN) ? 0 : 1;
    reinterpret_cast<ISP_CAM_PCA_CON2_T*>(REG_INFO_VALUE_PTR(DIP_X_PCA_CON2))->PCA_Y2YLUT_EN = (m_ePCAMode == EPCAMode_180BIN) ? 0 : 1;
