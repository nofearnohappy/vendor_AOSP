...
public:
    ...
    virtual MINT32 DoEis(const EIS_PASS_ENUM &aEisPass, QBufInfo const &pBufInfo) = 0;
    ...
    virtual MINT32 GetBufEis(android::sp<IImageBuffer>& spBuf) = 0;
    virtual MINT32 NotifyEis(QBufInfo&  pBufInfo) = 0;
