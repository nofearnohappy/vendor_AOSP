 ...
 */
#ifndef MTK_PIPE_MGR_IMP_ZSD_PRV_INC_H
#define MTK_PIPE_MGR_IMP_ZSD_PRV_INC_H
//
/*******************************************************************************
*
*******************************************************************************/
...
class PipeMgrImpZsdPrv : public NSMtkPipeMgrImp::PipeMgrImpNorPrv
{
    public:
                PipeMgrImpZsdPrv(MUINT32 openId, EPipeScen pipeScenario);
                ~PipeMgrImpZsdPrv();
    ...
    protected:
        ...
        virtual MVOID   getInitRrzoSize(
                            ...
                            MINT&   height);
        //member variables
        sp<ZsdPrvStreamBufHandler>      mspZsdPrvStreamBufHandler;
