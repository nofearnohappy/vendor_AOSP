 ...
 */
#ifndef MTK_PIPE_MGR_IMP_VDO_REC_INC_H
#define MTK_PIPE_MGR_IMP_VDO_REC_INC_H
//
/*******************************************************************************
*
*******************************************************************************/
...
class PipeMgrImpVdoRec : public NSMtkPipeMgrImp::PipeMgrImpNorPrv
{
    public:
                PipeMgrImpVdoRec(MUINT32 openId, EPipeScen pipeScenario);
                ~PipeMgrImpVdoRec();
