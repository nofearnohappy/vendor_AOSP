 ...
 */
#ifndef MTK_PIPE_MGR_IMP_NOR_PRV_INC_H
#define MTK_PIPE_MGR_IMP_NOR_PRV_INC_H
//
/*******************************************************************************
*
*******************************************************************************/
...
class PipeMgrImpNorPrv : public NSMtkPipeMgrImp::PipeMgrImp
{
    public:
                PipeMgrImpNorPrv(MUINT32 openId, EPipeScen pipeScenario);
                ~PipeMgrImpNorPrv();
