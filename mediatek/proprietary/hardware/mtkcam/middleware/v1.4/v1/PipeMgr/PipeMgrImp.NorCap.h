 ...
 */
#ifndef MTK_PIPE_MGR_IMP_NOR_CAP_INC_H
#define MTK_PIPE_MGR_IMP_NOR_CAP_INC_H
//
/*******************************************************************************
*
*******************************************************************************/
...
class PipeMgrImpNorCap : public NSMtkPipeMgrImp::PipeMgrImp
{
    public:
                PipeMgrImpNorCap(MUINT32 openId, EPipeScen pipeScenario);
                ~PipeMgrImpNorCap();
    ...
    protected:
        ...
        virtual MVOID   setupStreamBufferProvider();
                MVOID   updateStreamBufferProvider() { return; }
