...
#-----------------------------------------------------------
LOCAL_SRC_FILES += RequestControllerImp.cpp
LOCAL_SRC_FILES += RequestControllerImp.request.cpp

#[workaround]
LOCAL_SRC_FILES += LegacyPipeline_Fake.cpp
#-----------------------------------------------------------
...
#-----------------------------------------------------------
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.bufferprovider
#
