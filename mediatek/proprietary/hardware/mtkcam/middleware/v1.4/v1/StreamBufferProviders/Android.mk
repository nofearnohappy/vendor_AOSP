...
#-----------------------------------------------------------
LOCAL_SRC_FILES += \
    HalImageStreamBufferProvider.cpp \
    CamClientStreamBufHandler.cpp \
    JpgStreamBufHandler.cpp \
    VssStreamBufHandler.cpp \
    ZsdShotStreamBufHandler.cpp \
    ZsdPrvStreamBufHandler.cpp \
    StereoPrvStreamBufHandler.cpp \
    StereoShotStreamBufHandler.cpp \
    StereoStreamBufHandler.cpp \
    StereoBufMgr.cpp \
    BufMgr.cpp \
...
LOCAL_C_INCLUDES += $(MTK_PATH_PLATFORM)/hardware/mtkcam/D1/v1/adapter/inc
...
LOCAL_MODULE := libcam.streambufprovider
#-----------------------------------------------------------
