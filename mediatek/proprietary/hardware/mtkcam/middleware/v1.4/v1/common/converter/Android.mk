...
#-----------------------------------------------------------
LOCAL_SRC_FILES += ConvertParam.cpp
LOCAL_SRC_FILES += RequestSettingBuilder.cpp
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/D1/v1/converter/
...
#-----------------------------------------------------------
LOCAL_MODULE := libcam3_converter
