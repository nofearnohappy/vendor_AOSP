...
#include <v1/converter/StaticMetaTable.h>
...
public:     ////                    Interface.
    //
                                    //ConvertParam();
                                    ConvertParamImp(MINT32 cameraId, sp<IParamsManager> pParamsMgr);

    virtual                         ~ConvertParamImp(){};

    //MERROR                        set(CameraParameters const& paramString);



    virtual MERROR                  convert(MtkCameraParameters const& paramString, IMetadata *request);
...
protected:
    ...
    //sp<IMetadataProvider>           mpMetadataProvider;
    MINT32                          mLogLevel;
    ...
    , mpParamsMgr(pParamsMgr)
{
    ...
    mLogLevel = 1;
    sp<IMetadataProvider> pMetadataProvider = NSMetadataProviderManager::valueFor(mCameraId);
...
{
    return new ConvertParamImp(cameraId, pParamsMgr);
}
/******************************************************************************
 *
 ******************************************************************************/
...
MERROR
ConvertParamImp::
convert(MtkCameraParameters const& paramString, IMetadata *request)
{
    my_params params;
    set(params);
...
updateRequest(IMetadata *request, my_params const& params) const
{
    ...
    if(params.mUseParmsFocusMode) {
        switch (params.mParamFocusMode) {
            case ConvertParamImp::FOCUS_MODE_AUTO:
            case ConvertParamImp::FOCUS_MODE_MACRO:
            case ConvertParamImp::FOCUS_MODE_CONTINUOUS_VIDEO:
            case ConvertParamImp::FOCUS_MODE_CONTINUOUS_PICTURE:
            case ConvertParamImp::FOCUS_MODE_EDOF:
                reqFocusMode = params.mParamFocusMode;
                break;
            case ConvertParamImp::FOCUS_MODE_INFINITY:
            case ConvertParamImp::FOCUS_MODE_FIXED:
 ...
 ******************************************************************************/
#if 0
IMetadata::IEntry ConvertParamImp::staticInfo(uint32_t tag) const {
 ...
 *
 ******************************************************************************/
int ConvertParamImp::wbModeStringToEnum(const char *wbMode) {
    return
        !wbMode ?
 ...
 *
 ******************************************************************************/
bool ConvertParamImp::boolFromString(const char *boolStr) {
 ...
 *
 ******************************************************************************/
int ConvertParamImp::effectModeStringToEnum(const char *effectMode) {
    return
        !effectMode ?
 ...
 *
 ******************************************************************************/
MINT32 ConvertParamImp::abModeStringToEnum(const char *abMode) {
    return
        !abMode ?
 ...
 *
 ******************************************************************************/
MINT32 ConvertParamImp::sceneModeStringToEnum(const char *sceneMode) {
    return
        !sceneMode ?
 ...
 *
 ******************************************************************************/
MRect ConvertParamImp::calculateCropRegion() const {
