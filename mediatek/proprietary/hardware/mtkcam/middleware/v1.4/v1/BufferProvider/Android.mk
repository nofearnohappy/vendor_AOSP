...
#-----------------------------------------------------------
LOCAL_SRC_FILES += StreamBufferProviderFactory.cpp
#
LOCAL_SRC_FILES += StreamBufferProviderImp.provider.cpp
LOCAL_SRC_FILES += StreamBufferProviderImp.consumer.cpp
#
LOCAL_SRC_FILES += BufferPoolImp.cpp
#-----------------------------------------------------------
...
LOCAL_MODULE := libcam.bufferprovider
#-----------------------------------------------------------
