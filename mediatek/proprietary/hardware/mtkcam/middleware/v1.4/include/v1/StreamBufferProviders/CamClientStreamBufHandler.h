...
#ifndef _MTK_CAMERA_INCLUDE_CAM_CLIENT_STREAM_BUF_HANDLER_H_
#define _MTK_CAMERA_INCLUDE_CAM_CLIENT_STREAM_BUF_HANDLER_H_
//
...
********************************************************************************/
    ...
    class CamClientStreamBufHandler : public IStreamBufferProvider
    {
        public:     ////    Instantiation.
            static CamClientStreamBufHandler*   createInstance(
                                                    MUINT32     openId,
                                                    const char* userName,
                                                    android::sp<ImgBufProvidersManager>  spImgBufProvidersMgr);
            ...
            virtual MERROR                      dequeStreamBuffer(
                                                    ...
                                                    android::sp<HalImageStreamBuffer> &rpStreamBuffer) = 0;
        ...
        protected:  ////    Constructor/Destructor.
            ...
            virtual ~CamClientStreamBufHandler();
...
#endif  //_MTK_CAMERA_INCLUDE_CAM_CLIENT_STREAM_BUF_HANDLER_H_
