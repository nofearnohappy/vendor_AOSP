 ...
 ************************************************************************************************/
#ifndef MTK_PIPE_DATA_INFO_H
#define MTK_PIPE_DATA_INFO_H
namespace NSMtkPipeDataInfo
{
    struct PipeDataInfo
    {
        /**
        ...
        PipeDataInfo(
            ...
            android::sp<IImageBufferHeap> const _pData = NULL
        )
            : msgType(_msgType)
            , ext1(_ext1)
            , ext2(_ext2)
