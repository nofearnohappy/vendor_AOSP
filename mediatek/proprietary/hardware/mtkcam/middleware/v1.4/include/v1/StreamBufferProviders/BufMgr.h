...
#ifndef _MTK_CAMERA_INCLUDE_DEFAULT_BUF_MGR_H_
#define _MTK_CAMERA_INCLUDE_DEFAULT_BUF_MGR_H_
...
class BufMgr
{
    ...
    //
    public:
        static BufMgr*  createInstance(MUINT32 openId);
        ...
        virtual MBOOL   pushBuf(sp<IImageBufferHeap> pImageBuffer, MUINT32 iReqNum)         = 0;
        //Get buffer length
