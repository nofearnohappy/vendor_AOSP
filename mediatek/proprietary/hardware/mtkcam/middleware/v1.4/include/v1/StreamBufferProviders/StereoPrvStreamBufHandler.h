...
#ifndef _MTK_CAMERA_INCLUDE_STEREO_PRV_STREAM_BUF_HANDLER_H_
#define _MTK_CAMERA_INCLUDE_STEREO_PRV_STREAM_BUF_HANDLER_H_
//
/******************************************************************************
*
*******************************************************************************/
...
********************************************************************************/
    ...
    class StereoPrvStreamBufHandler : public IStreamBufferProvider
    {
        public:     ////    Instantiation.
            static StereoPrvStreamBufHandler*    createInstance(
                                                        MUINT32     openId,
                                                        const char* userName);
        ...
        public:
            typedef struct
            {
                StereoBufMgr*           pBufMgr;
                MUINT32                 uiKeepBufCount;
                sp<IImageStreamInfo>    pStreamInfo;
            }CONFIG_INFO;
        public:
            virtual MBOOL   setConfig(CONFIG_INFO configInfo)                             = 0;
            virtual MBOOL   setProviderWrapper(sp<IStreamBufferProvider> wrapper)         = 0;
        //
        protected:  ////    Constructor/Destructor.
                    StereoPrvStreamBufHandler();
            virtual ~StereoPrvStreamBufHandler();
...
#endif  //_MTK_CAMERA_INCLUDE_STEREO_PRV_STREAM_BUF_HANDLER_H_
